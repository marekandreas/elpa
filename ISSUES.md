...
### ELPA 2026.02.002 release ###
Currently no known issues

### ELPA 2026.02.001 release ###
as in 2025.06.002

### ELPA 2025.06.002 release ###
PERFORMANCE REGRESSION in ELPA2 with OpenMP: the tridiagonal-to-band transformation
  forced the non-GPU OpenMP path to use max_threads=1; FIXED in 2026.02.002

### ELPA 2025.06.001 release ###
BUG in solve-tridi, which can in rare situations lead to wrong results; FIXED in 2025.06.002
PERFORMANCE REGRESSION in ELPA2 with OpenMP: the tridiagonal-to-band transformation
  forced the non-GPU OpenMP path to use max_threads=1; FIXED in 2026.02.002
