...
__global__ void hip_fill_tmp_arrays_double_kernel(int *idx1, int *p_col, int *coltyp, int *nnzu_val, int *nnzl_val, double *d1u, double *d1, double *zu, double *z, double *d1l, double *zl, const int na, const int np, const int na1, const int np_rem) {
...
extern "C" void hip_fill_tmp_arrays_double_FromC(int *idx1_dev, int *p_col_dev, int *coltyp_dev, int *nnzu_val_dev, int *nnzl_val_dev, double *d1u_dev, double *d1_dev, double *zu_dev, double *z_dev, double *d1l_dev, double *zl_dev, int *na_in, int *np_in, int *na1_in, int *np_rem_in, hipStream_t  my_stream){
  int na = *na_in;
  int np = *np_in;
  int na1 = *na1_in;
  ...
  hip_fill_tmp_arrays_double_kernel<<<blocks, threadsPerBlock, 0, my_stream>>>(idx1_dev, p_col_dev, coltyp_dev, nnzu_val_dev, nnzl_val_dev, d1u_dev, d1_dev, zu_dev, z_dev, d1l_dev, zl_dev, na, np, na1, np_rem);
#else
  hip_fill_tmp_arrays_double_kernel<<<blocks, threadsPerBlock>>>              (idx1_dev, p_col_dev, coltyp_dev, nnzu_val_dev, nnzl_val_dev, d1u_dev, d1_dev, zu_dev, z_dev, d1l_dev, zl_dev, na, np, na1, np_rem);
#endif
...
__global__ void hip_fill_tmp_arrays_float_kernel(int *idx1, int *p_col, int *coltyp, int *nnzu_val, int *nnzl_val, float *d1u, float *d1, float *zu, float *z, float *d1l, float *zl, const int na, const int np, const int na1, const int np_rem) {
    int i = blockIdx.x * blockDim.x + threadIdx.x;
    if (i>=0 && i < na1) {
      int index = idx1[i] - 1;
      if (p_col[index] == np_rem) {
...
extern "C" void hip_fill_tmp_arrays_float_FromC(int *idx1_dev, int *p_col_dev, int *coltyp_dev, int *nnzu_val_dev, int *nnzl_val_dev, float *d1u_dev, float *d1_dev, float *zu_dev, float *z_dev, float *d1l_dev, float *zl_dev, int *na_in, int *np_in, int *na1_in, int *np_rem_in, hipStream_t  my_stream){
  int na = *na_in;
  int np = *np_in;
  int na1 = *na1_in;
  int np_rem = *np_rem_in;
...
#ifdef WITH_GPU_STREAMS
  hip_fill_tmp_arrays_float_kernel<<<blocks, threadsPerBlock, 0, my_stream>>>(idx1_dev, p_col_dev, coltyp_dev, nnzu_val_dev, nnzl_val_dev, d1u_dev, d1_dev, zu_dev, z_dev, d1l_dev, zl_dev, na, np, na1, np_rem);
#else
  hip_fill_tmp_arrays_float_kernel<<<blocks, threadsPerBlock>>>              (idx1_dev, p_col_dev, coltyp_dev, nnzu_val_dev, nnzl_val_dev, d1u_dev, d1_dev, zu_dev, z_dev, d1l_dev, zl_dev, na, np, na1, np_rem);
#endif
