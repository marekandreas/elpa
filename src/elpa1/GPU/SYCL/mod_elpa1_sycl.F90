...
module elpa1_sycl
  ...
  interface
    subroutine sycl_dot_product_double_c(n, x_dev, incx, y_dev, incy, result_dev, wantDebug, my_stream) &
  ...
  interface
    subroutine sycl_dot_product_float_c(n, x_dev, incx, y_dev, incy, result_dev, wantDebug, my_stream) &
  ...
  interface
    subroutine sycl_dot_product_double_complex_c(n, x_dev, incx, y_dev, incy, result_dev, wantDebug, my_stream) &
  ...
  interface
  subroutine sycl_dot_product_float_complex_c(n, x_dev, incx, y_dev, incy, result_dev, wantDebug, my_stream) &
  ...
  interface
    subroutine sycl_set_e_vec_scale_set_one_store_v_row_double_c(e_vec_dev, vrl_dev, a_dev, v_row_dev, tau_dev, xf_host_or_dev, &
  ...
  interface
    subroutine sycl_set_e_vec_scale_set_one_store_v_row_float_c(e_vec_dev, vrl_dev, a_dev, v_row_dev, tau_dev, xf_host_or_dev, &
                                                l_rows, l_cols, matrixRows, istep, isOurProcessRow, useCCL, wantDebug, my_stream) &
  ...
  interface
    subroutine sycl_set_e_vec_scale_set_one_store_v_row_double_complex_c(e_vec_dev, vrl_dev, a_dev, & 
  ...
  interface
    subroutine sycl_set_e_vec_scale_set_one_store_v_row_float_complex_c(e_vec_dev, vrl_dev, a_dev, & 
                                                v_row_dev, tau_dev, xf_host_or_dev, &
                                                l_rows, l_cols, matrixRows, istep, isOurProcessRow, useCCL, wantDebug, my_stream) &
  ...
  subroutine sycl_dot_product_double(n, x_dev, incx, y_dev, incy, result_dev, wantDebug, my_stream)
    use, intrinsic :: iso_c_binding
    implicit none
...
#ifdef WITH_SYCL_GPU_VERSION
    call sycl_dot_product_double_c(n, x_dev, incx, y_dev, incy, result_dev, wantDebug, my_stream)
#endif
  end subroutine


  subroutine sycl_dot_product_float(n, x_dev, incx, y_dev, incy, result_dev, wantDebug, my_stream)
    use, intrinsic :: iso_c_binding
    implicit none
...
#ifdef WITH_SYCL_GPU_VERSION
    call sycl_dot_product_float_c(n, x_dev, incx, y_dev, incy, result_dev, wantDebug, my_stream)
#endif
  end subroutine


  subroutine sycl_dot_product_double_complex(n, x_dev, incx, y_dev, incy, result_dev, wantDebug, my_stream)
    use, intrinsic :: iso_c_binding
    implicit none
...
#ifdef WITH_SYCL_GPU_VERSION
    call sycl_dot_product_double_complex_c(n, x_dev, incx, y_dev, incy, result_dev, wantDebug, my_stream)
#endif
  end subroutine


  subroutine sycl_dot_product_float_complex(n, x_dev, incx, y_dev, incy, result_dev, wantDebug, my_stream)
    use, intrinsic :: iso_c_binding
    implicit none
...
#ifdef WITH_SYCL_GPU_VERSION
    call sycl_dot_product_float_complex_c(n, x_dev, incx, y_dev, incy, result_dev, wantDebug, my_stream)
#endif
  end subroutine
  ...
  subroutine sycl_set_e_vec_scale_set_one_store_v_row_double(e_vec_dev, vrl_dev, a_dev, v_row_dev, tau_dev, xf_host_or_dev, &
                                                l_rows, l_cols, matrixRows, istep, isOurProcessRow, useCCL, wantDebug, my_stream)
    use, intrinsic :: iso_c_binding
    implicit none
...
#ifdef WITH_SYCL_GPU_VERSION
    call sycl_set_e_vec_scale_set_one_store_v_row_double_c(e_vec_dev, vrl_dev, a_dev, v_row_dev, tau_dev, xf_host_or_dev, &
                                            l_rows, l_cols, matrixRows, istep, isOurProcessRow, useCCL, wantDebug, my_stream)
#endif
  end subroutine


  subroutine sycl_set_e_vec_scale_set_one_store_v_row_float(e_vec_dev, vrl_dev, a_dev, v_row_dev, tau_dev, xf_host_or_dev, &
    l_rows, l_cols, matrixRows, istep, isOurProcessRow, useCCL, wantDebug, my_stream)
    use, intrinsic :: iso_c_binding
    implicit none
...
#ifdef WITH_SYCL_GPU_VERSION
    call sycl_set_e_vec_scale_set_one_store_v_row_float_c(e_vec_dev, vrl_dev, a_dev, v_row_dev, tau_dev, xf_host_or_dev, &
                                            l_rows, l_cols, matrixRows, istep, isOurProcessRow, useCCL, wantDebug, my_stream)
#endif
  end subroutine


  subroutine sycl_set_e_vec_scale_set_one_store_v_row_double_complex(e_vec_dev, vrl_dev, a_dev, v_row_dev, tau_dev,xf_host_or_dev,&
                                                l_rows, l_cols, matrixRows, istep, isOurProcessRow, useCCL, wantDebug, my_stream)
    use, intrinsic :: iso_c_binding
    implicit none
...
#ifdef WITH_SYCL_GPU_VERSION
    call sycl_set_e_vec_scale_set_one_store_v_row_double_complex_c(e_vec_dev, vrl_dev, a_dev, v_row_dev, tau_dev, xf_host_or_dev, &
                                            l_rows, l_cols, matrixRows, istep, isOurProcessRow, useCCL, wantDebug, my_stream)
#endif
  end subroutine


  subroutine sycl_set_e_vec_scale_set_one_store_v_row_float_complex(e_vec_dev, vrl_dev, a_dev, v_row_dev, tau_dev, xf_host_or_dev, &
    l_rows, l_cols, matrixRows, istep, isOurProcessRow, useCCL, wantDebug, my_stream)
    use, intrinsic :: iso_c_binding
    implicit none
...
#ifdef WITH_SYCL_GPU_VERSION
    call sycl_set_e_vec_scale_set_one_store_v_row_float_complex_c(e_vec_dev, vrl_dev, a_dev, v_row_dev, tau_dev, xf_host_or_dev, &
                                            l_rows, l_cols, matrixRows, istep, isOurProcessRow, useCCL, wantDebug, my_stream)
#endif
  end subroutine
