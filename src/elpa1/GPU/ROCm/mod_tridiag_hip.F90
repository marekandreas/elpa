...
module tridiag_hip
  ...
  interface
    subroutine hip_dot_product_double_c(n, x_dev, incx, y_dev, incy, result_dev, wantDebug, sm_count, my_stream) &
  ...
  interface
    subroutine hip_dot_product_float_c(n, x_dev, incx, y_dev, incy, result_dev, wantDebug, sm_count, my_stream) &
  ...
  interface
    subroutine hip_dot_product_double_complex_c(n, x_dev, incx, y_dev, incy, result_dev, wantDebug, sm_count, my_stream) &
  ...
  interface
    subroutine hip_dot_product_float_complex_c(n, x_dev, incx, y_dev, incy, result_dev, wantDebug, sm_count, my_stream) &
...
#ifdef WITH_AMD_GPU_VERSION
      call hip_dot_product_double_c(n, x_dev, incx, y_dev, incy, result_dev, wantDebug, sm_count, my_stream)
#endif
...
#ifdef WITH_AMD_GPU_VERSION
      call hip_dot_product_float_c(n, x_dev, incx, y_dev, incy, result_dev, wantDebug, sm_count, my_stream)
#endif
...
#ifdef WITH_AMD_GPU_VERSION
      call hip_dot_product_double_complex_c(n, x_dev, incx, y_dev, incy, result_dev, wantDebug, sm_count, my_stream)
#endif
...
#ifdef WITH_AMD_GPU_VERSION
      call hip_dot_product_float_complex_c(n, x_dev, incx, y_dev, incy, result_dev, wantDebug, sm_count, my_stream)
#endif
