...
!f> interface
!f>   subroutine double_hh_trafo_real_NEON_2hv_double(q, hh, pnb, pnq, pldq, pldh) &
!f>              bind(C, name="double_hh_trafo_real_NEON_2hv_double")
...
!f>#ifdef HAVE_SSE_INTRINSICS
!f> interface
!f>   subroutine double_hh_trafo_real_NEON_2hv_single(q, hh, pnb, pnq, pldq, pldh) &
!f>              bind(C, name="double_hh_trafo_real_NEON_2hv_single")
!f>     use, intrinsic :: iso_c_binding
!f>     integer(kind=c_int) :: pnb, pnq, pldq, pldh
!f>     type(c_ptr), value  :: q
...
#ifdef HAVE_SSE_INTRINSICS
                h1 = _SSE_SET1(hh[i-1]);
                h2 = _SSE_SET1(hh[ldh+i]);
#endif
#ifdef HAVE_SPARC64_SSE
                h1 = _SSE_SET(hh[i-1], hh[i-1]);
                h2 = _SSE_SET(hh[ldh+i], hh[ldh+i]);
#endif
