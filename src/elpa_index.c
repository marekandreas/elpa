...
static const elpa_index_int_entry_t int_entries[] = {
	...
	INT_ENTRY("use_gpu_id", "Calling MPI task will use this gpu id", -99, ELPA_AUTOTUNE_NOT_TUNABLE, ELPA_AUTOTUNE_NOT_TUNABLE, ELPA_AUTOTUNE_DOMAIN_ANY, ELPA_AUTOTUNE_PART_NONE, \
        ...
        BOOL_ENTRY("use-ccl", "Use NVIDIA's nccl or AMD's rccl communication libraries", 1, ELPA_AUTOTUNE_GPU, ELPA_AUTOTUNE_GPU, ELPA_AUTOTUNE_DOMAIN_ANY, ELPA_AUTOTUNE_PART_ANY, PRINT_YES), 
#else
        BOOL_ENTRY("use-ccl", "Use NVIDIA's nccl or AMD's rccl communication libraries", 0, ELPA_AUTOTUNE_GPU, ELPA_AUTOTUNE_GPU, ELPA_AUTOTUNE_DOMAIN_ANY, ELPA_AUTOTUNE_PART_ANY, PRINT_YES), 
#endif
	// 1. non-blocking MPI
