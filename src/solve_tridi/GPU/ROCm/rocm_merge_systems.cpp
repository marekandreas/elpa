...
__global__ void hip_fill_tmp_arrays_double_kernel(int *idx1, int *p_col, int *coltyp, int *nnzu_val, int *nnzl_val, int *nnzul, double *d1u, double *d1, double *zu, double *z, double *d1l, double *zl, const int na, const int np, const int na1, const int np_rem) {
...
extern "C" void hip_fill_tmp_arrays_double_FromC(int *idx1_dev, int *p_col_dev, int *coltyp_dev, int *nnzu_val_dev, int *nnzl_val_dev, int *nnzul_dev, double *d1u_dev, double *d1_dev, double *zu_dev, double *z_dev, double *d1l_dev, double *zl_dev, int *na_in, int *np_in, int *na1_in, int *np_rem_in, hipStream_t  my_stream){
  int na = *na_in;
  int np = *np_in;
  int na1 = *na1_in;
  ...
  hip_fill_tmp_arrays_double_kernel<<<blocks, threadsPerBlock, 0, my_stream>>>(idx1_dev, p_col_dev, coltyp_dev, nnzu_val_dev, nnzl_val_dev, nnzul_dev, d1u_dev, d1_dev, zu_dev, z_dev, d1l_dev, zl_dev, na, np, na1, np_rem);
#else
  hip_fill_tmp_arrays_double_kernel<<<blocks, threadsPerBlock>>>              (idx1_dev, p_col_dev, coltyp_dev, nnzu_val_dev, nnzl_val_dev, nnzul_dev, d1u_dev, d1_dev, zu_dev, z_dev, d1l_dev, zl_dev, na, np, na1, np_rem);
#endif

  hipError_t cuerr = hipGetLastError();
  if (cuerr != hipSuccess){
    printf("Error in executing hip_fill_tmp_arrays_double_kernel: %s\n",hipGetErrorString(cuerr));
  }
}
...
extern "C" void hip_fill_tmp_arrays_float_FromC(int *idx1_dev, int *p_col_dev, int *coltyp_dev, int *nnzu_val_dev, int *nnzl_val_dev, int *nnzul_dev, float *d1u_dev, float *d1_dev, float *zu_dev, float *z_dev, float *d1l_dev, float *zl_dev, int *na_in, int *np_in, int *na1_in, int *np_rem_in, hipStream_t  my_stream){
  int na = *na_in;
  int np = *np_in;
  int na1 = *na1_in;
  int np_rem = *np_rem_in;
...
#ifdef WITH_GPU_STREAMS
  hip_fill_tmp_arrays_float_kernel<<<blocks, threadsPerBlock, 0, my_stream>>>(idx1_dev, p_col_dev, coltyp_dev, nnzu_val_dev, nnzl_val_dev, nnzul_dev, d1u_dev, d1_dev, zu_dev, z_dev, d1l_dev, zl_dev, na, np, na1, np_rem);
#else
  hip_fill_tmp_arrays_float_kernel<<<blocks, threadsPerBlock>>>              (idx1_dev, p_col_dev, coltyp_dev, nnzu_val_dev, nnzl_val_dev, nnzul_dev, d1u_dev, d1_dev, zu_dev, z_dev, d1l_dev, zl_dev, na, np, na1, np_rem);
#endif
...
extern "C" void hip_copy_qtmp1_slice_to_q_double_FromC(double *q_dev, double *qtmp1_dev, int *l_col_out_dev, int *p_col_out_dev, int *ndef_c_dev, int *p_col_dev, int *idx2_dev, int *idx_dev, int *l_rqs_in, int *l_rqe_in, int *l_rows_in, int *matrixRows_in, int *gemm_dim_k_in, int *my_pcol_in, int *na1_in, int *np_rem_in, int *na_in, hipStream_t  my_stream){
  int l_rqs = *l_rqs_in;
  int l_rqe = *l_rqe_in;
  ...
  hipError_t cuerr = hipGetLastError();
  if (cuerr != hipSuccess){
    printf("Error in executing hip_copy_qtmp1_slice_to_q_double_kernel: %s\n",hipGetErrorString(cuerr));
  }
}
...
extern "C" void hip_copy_qtmp1_slice_to_q_float_FromC(float *q_dev, float *qtmp1_dev, int *l_col_out_dev, int *p_col_out_dev, int *ndef_c_dev, int *p_col_dev, int *idx2_dev, int *idx_dev, int *l_rqs_in, int *l_rqe_in, int *l_rows_in, int *matrixRows_in, int *gemm_dim_k_in, int *my_pcol_in, int *na1_in, int *np_rem_in, int *na_in, hipStream_t  my_stream){
  int l_rqs = *l_rqs_in;
  int l_rqe = *l_rqe_in;
  int l_rows = *l_rows_in;
  int matrixRows = *matrixRows_in;
...
extern "C" void hip_copy_q_slice_to_qtmp2_double_FromC(double *q_dev, double *qtmp2_dev, int *idxq1, int *l_col_out, int *l_rows_in, int *l_rqs_in, int *l_rqe_in, int *matrixRows_in, int *matrixCols_in, int *gemm_dim_k_in, int *gemm_dim_m_in, int *ns_in, int * ncnt_in, int *indx_in, int *indx2_in, int *na_in, hipStream_t  my_stream){
  int l_rows = *l_rows_in;
  int l_rqs = *l_rqs_in;
  int l_rqe = *l_rqe_in;
  int matrixRows = *matrixRows_in;
  ...
  hipError_t cuerr = hipGetLastError();
  if (cuerr != hipSuccess){
    printf("Error in executing hip_copy_q_slice_to_qtmp2_double_kernel: %s\n",hipGetErrorString(cuerr));
  }
}
...
extern "C" void hip_copy_q_slice_to_qtmp2_float_FromC(float *q_dev, float *qtmp2_dev, int *idxq1, int *l_col_out, int *l_rows_in, int *l_rqs_in, int *l_rqe_in, int *matrixRows_in, int *matrixCols_in, int *gemm_dim_k_in, int *gemm_dim_m_in, int *ns_in, int * ncnt_in, int *indx_in, int *indx2_in, int *na_in, hipStream_t  my_stream){
  int l_rows = *l_rows_in;
  int l_rqs = *l_rqs_in;
  int l_rqe = *l_rqe_in;
  int matrixRows = *matrixRows_in;
...
extern "C" void hip_copy_qtmp2_slice_to_q_double_FromC(double *q_dev, double *qtmp2_dev, int *idx1q_dev, int *l_col_out_dev, int *l_rqs_in, int *l_rqe_in, int *l_rows_in, int *ncnt_in, int *gemm_dim_k_in, int *matrixRows_in, int *ns_in, hipStream_t  my_stream){
...
#ifdef WITH_GPU_STREAMS
  hip_copy_qtmp2_slice_to_q_double_kernel<<<blocks, threadsPerBlock, 0, my_stream>>>(q_dev, qtmp2_dev, idx1q_dev, l_col_out_dev, l_rqs, l_rqe, l_rows, ncnt, gemm_dim_k, matrixRows, ns);
#else
  hip_copy_qtmp2_slice_to_q_double_kernel<<<blocks, threadsPerBlock>>>(q_dev, qtmp2_dev, idx1q_dev, l_col_out_dev, l_rqs, l_rqe, l_rows, ncnt, gemm_dim_k, matrixRows, ns);
#endif

  hipError_t cuerr = hipGetLastError();
  if (cuerr != hipSuccess){
    printf("Error in executing hip_copy_qtmp2_slice_to_q_double_kernel: %s\n",hipGetErrorString(cuerr));
  }
}
...
extern "C" void hip_copy_qtmp2_slice_to_q_float_FromC(float *q_dev, float *qtmp2_dev, int *idx1q_dev, int *l_col_out_dev, int *l_rqs_in, int *l_rqe_in, int *l_rows_in, int *ncnt_in, int *gemm_dim_k_in, int *matrixRows_in, int *ns_in, hipStream_t  my_stream){
...
#ifdef WITH_GPU_STREAMS
  hip_copy_qtmp2_slice_to_q_float_kernel<<<blocks, threadsPerBlock, 0, my_stream>>>(q_dev, qtmp2_dev, idx1q_dev, l_col_out_dev, l_rqs, l_rqe, l_rows, ncnt, gemm_dim_k, matrixRows, ns);
#else
  hip_copy_qtmp2_slice_to_q_float_kernel<<<blocks, threadsPerBlock>>>(q_dev, qtmp2_dev, idx1q_dev, l_col_out_dev, l_rqs, l_rqe, l_rows, ncnt, gemm_dim_k, matrixRows, ns);
#endif
...
extern "C" void hip_zero_q_double_FromC(double *q_dev, int *p_col_out_dev, int *l_col_out_dev, int *na_in, int *my_pcol_in, int *l_rqs_in, int *l_rqe_in, int *matrixRows_in, hipStream_t  my_stream){
...
#ifdef WITH_GPU_STREAMS
  hip_zero_q_double_kernel<<<blocks, threadsPerBlock, 0, my_stream>>>(q_dev, p_col_out_dev, l_col_out_dev, na, my_pcol, l_rqs, l_rqe, matrixRows);
#else
  hip_zero_q_double_kernel<<<blocks, threadsPerBlock>>>(q_dev, p_col_out_dev, l_col_out_dev, na, my_pcol, l_rqs, l_rqe, matrixRows);
#endif

  hipError_t cuerr = hipGetLastError();
  if (cuerr != hipSuccess){
    printf("Error in executing hip_zero_q_double_kernel: %s\n",hipGetErrorString(cuerr));
  }
}
...
#else
  hip_zero_q_float_kernel<<<blocks, threadsPerBlock>>>(q_dev, p_col_out_dev, l_col_out_dev, na, my_pcol, l_rqs, l_rqe, matrixRows);
#endif
...
extern "C" void hip_copy_q_slice_to_qtmp1_double_FromC(double *qtmp1_dev, double *q_dev, int *ndef_c_dev, int *l_col_dev, int *idx2_dev, int *p_col_dev, int *na2_in, int *na_in, int *my_pcol_in, int *l_rows_in, int *l_rqs_in, int *l_rqe_in, int *matrixRows_in, int *gemm_dim_k_in, hipStream_t  my_stream){
...
#ifdef WITH_GPU_STREAMS
  hip_copy_q_slice_to_qtmp1_double_kernel<<<blocks, threadsPerBlock, 0, my_stream>>>(qtmp1_dev, q_dev, ndef_c_dev, l_col_dev, idx2_dev, p_col_dev, na2, na2, my_pcol, l_rows, l_rqs, l_rqe, matrixRows, gemm_dim_k);
#else
  hip_copy_q_slice_to_qtmp1_double_kernel<<<blocks, threadsPerBlock>>>(qtmp1_dev, q_dev, ndef_c_dev, l_col_dev, idx2_dev, p_col_dev, na2, na, my_pcol, l_rows, l_rqs, l_rqe, matrixRows, gemm_dim_k);
#endif

  hipError_t cuerr = hipGetLastError();
  if (cuerr != hipSuccess){
    printf("Error in executing hip_copy_q_slice_to_qtmp1_double_kernel: %s\n",hipGetErrorString(cuerr));
  }
}
...
extern "C" void hip_copy_q_slice_to_qtmp1_float_FromC(float *qtmp1_dev, float *q_dev, int *ndef_c_dev, int *l_col_dev, int *idx2_dev, int *p_col_dev, int *na2_in, int *na_in, int *my_pcol_in, int *l_rows_in, int *l_rqs_in, int *l_rqe_in, int *matrixRows_in, int *gemm_dim_k_in, hipStream_t  my_stream){
...
#ifdef WITH_GPU_STREAMS
  hip_copy_q_slice_to_qtmp1_float_kernel<<<blocks, threadsPerBlock, 0, my_stream>>>(qtmp1_dev, q_dev, ndef_c_dev, l_col_dev, idx2_dev, p_col_dev, na2, na2, my_pcol, l_rows, l_rqs, l_rqe, matrixRows, gemm_dim_k);
#else
  hip_copy_q_slice_to_qtmp1_float_kernel<<<blocks, threadsPerBlock>>>(qtmp1_dev, q_dev, ndef_c_dev, l_col_dev, idx2_dev, p_col_dev, na2, na, my_pcol, l_rows, l_rqs, l_rqe, matrixRows, gemm_dim_k);
#endif
...
extern "C" void hip_copy_qtmp1_to_qtmp1_tmp_double_FromC(double *qtmp1_dev, double *qtmp1_tmp_dev, int *gemm_dim_k_in, int *gemm_dim_l_in, hipStream_t  my_stream){
...
#ifdef WITH_GPU_STREAMS
  hip_copy_qtmp1_to_qtmp1_tmp_double_kernel<<<blocks, threadsPerBlock, 0, my_stream>>>(qtmp1_dev, qtmp1_tmp_dev, gemm_dim_k, gemm_dim_l);
#else     
  hip_copy_qtmp1_to_qtmp1_tmp_double_kernel<<<blocks, threadsPerBlock>>>(qtmp1_dev, qtmp1_tmp_dev, gemm_dim_k, gemm_dim_l);
#endif
...
extern "C" void hip_update_ndef_c_FromC(int *ndef_c_dev, int *idx_dev, int *p_col_dev, int *idx2_dev, int *na_in, int *na1_in, int *np_rem_in, int *ndef_in, hipStream_t  my_stream){
...
#ifdef WITH_GPU_STREAMS
  hip_update_ndef_c_kernel<<<blocks, threadsPerBlock, 0, my_stream>>>(ndef_c_dev, idx_dev, p_col_dev, idx2_dev, na, na1, np_rem, ndef);
#else
  hip_update_ndef_c_kernel<<<blocks, threadsPerBlock>>>(ndef_c_dev, idx_dev, p_col_dev, idx2_dev, na, na1, np_rem, ndef);
#endif

  hipError_t cuerr = hipGetLastError();
  if (cuerr != hipSuccess){
    printf("Error in executing hip_update_ndef_c_kernel: %s\n",hipGetErrorString(cuerr));
  }
}



__global__ void hip_compute_nnzl_nnzu_val_part1_kernel(int *p_col, int *idx1, int *coltyp, int *nnzu_val, int *nnzl_val, const int na, const int na1, const int np_rem, const int npc_n, const int nnzu_start, const int nnzl_start, const int np_in){
...
extern "C" void hip_compute_nnzl_nnzu_val_part1_FromC(int *p_col_dev, int *idx1_dev, int *coltyp_dev, int *nnzu_val_dev, int *nnzl_val_dev, int *na_in, int *na1_in, int *np_rem_in, int *npc_n_in, int *nnzu_start_in, int *nnzl_start_in, int *np_in, hipStream_t  my_stream){
...
#ifdef WITH_GPU_STREAMS
  hip_compute_nnzl_nnzu_val_part1_kernel<<<blocks, threadsPerBlock, 0, my_stream>>>(p_col_dev, idx1_dev, coltyp_dev, nnzu_val_dev, nnzl_val_dev, na, na1, np_rem, npc_n, nnzu_start, nnzl_start, np);
#else
  hip_compute_nnzl_nnzu_val_part1_kernel<<<blocks, threadsPerBlock>>>(p_col_dev, idx1_dev, coltyp_dev, nnzu_val_dev, nnzl_val_dev, na, na1, np_rem, npc_n, nnzu_start, nnzl_start, np);
#endif

  hipError_t cuerr = hipGetLastError();
  if (cuerr != hipSuccess){
    printf("Error in executing hip_compute_nnzl_nnzu_val_part1_c_kernel: %s\n",hipGetErrorString(cuerr));
  }
}
...
__global__ void hip_compute_nnzl_nnzu_val_part2_kernel(int *nnzu_val, int *nnzl_val, const int na, const int na1, int nnzu_start, const int nnzl_start, const int npc_n){
...
extern "C" void hip_compute_nnzl_nnzu_val_part2_FromC(int *nnzu_val_dev, int *nnzl_val_dev, int *na_in, int *na1_in, int *nnzu_start_in, int *nnzl_start_in, int *npc_n_in, hipStream_t  my_stream){
...
#ifdef WITH_GPU_STREAMS
  hip_compute_nnzl_nnzu_val_part2_kernel<<<blocks, threadsPerBlock, 0, my_stream>>>(nnzu_val_dev, nnzl_val_dev, na, na1, nnzu_start, nnzl_start, npc_n);
#else
  hip_compute_nnzl_nnzu_val_part2_kernel<<<blocks, threadsPerBlock>>>(nnzu_val_dev, nnzl_val_dev, na, na1, nnzu_start, nnzl_start, npc_n);
#endif
