...
__forceinline void hh_trafo_kernel_8_SSE_6hv_single(float* q, float* hh, int nb, int ldq, int ldh, float* scalarprods)
{
	...
	__m128 a1_1 = _mm_load_ps(&q[ldq*5]);
	__m128 a2_1 = _mm_load_ps(&q[ldq*4]);
	__m128 a3_1 = _mm_load_ps(&q[ldq*3]);
	__m128 a4_1 = _mm_load_ps(&q[ldq*2]);
	__m128 a5_1 = _mm_load_ps(&q[ldq]);
	__m128 a6_1 = _mm_load_ps(&q[0]);

	__m128 h_6_5 =   _mm_moveldup_ps( _mm_castpd_ps(_mm_loaddup_pd( (double *) &hh[(ldh*5)+1]) ));
	__m128 h_6_4 =   _mm_moveldup_ps( _mm_castpd_ps(_mm_loaddup_pd( (double *) &hh[(ldh*5)+2]) ));
	__m128 h_6_3 =   _mm_moveldup_ps( _mm_castpd_ps(_mm_loaddup_pd( (double *) &hh[(ldh*5)+3]) ));
	__m128 h_6_2 =   _mm_moveldup_ps( _mm_castpd_ps(_mm_loaddup_pd( (double *) &hh[(ldh*5)+4]) ));
	__m128 h_6_1 =   _mm_moveldup_ps( _mm_castpd_ps(_mm_loaddup_pd( (double *) &hh[(ldh*5)+5]) ));

	register __m128 t1 = _mm_add_ps(a6_1, _mm_mul_ps(a5_1, h_6_5));
	t1 = _mm_add_ps(t1, _mm_mul_ps(a4_1, h_6_4));
	t1 = _mm_add_ps(t1, _mm_mul_ps(a3_1, h_6_3));
	t1 = _mm_add_ps(t1, _mm_mul_ps(a2_1, h_6_2));
	t1 = _mm_add_ps(t1, _mm_mul_ps(a1_1, h_6_1));

	__m128 h_5_4 =   _mm_moveldup_ps( _mm_castpd_ps(_mm_loaddup_pd( (double *) &hh[(ldh*4)+1]) ));
	__m128 h_5_3 =   _mm_moveldup_ps( _mm_castpd_ps(_mm_loaddup_pd( (double *) &hh[(ldh*4)+2]) ));
	__m128 h_5_2 =   _mm_moveldup_ps( _mm_castpd_ps(_mm_loaddup_pd( (double *) &hh[(ldh*4)+3]) ));
	__m128 h_5_1 =   _mm_moveldup_ps( _mm_castpd_ps(_mm_loaddup_pd( (double *) &hh[(ldh*4)+4]) ));

	register __m128 v1 = _mm_add_ps(a5_1, _mm_mul_ps(a4_1, h_5_4));
	v1 = _mm_add_ps(v1, _mm_mul_ps(a3_1, h_5_3));
	v1 = _mm_add_ps(v1, _mm_mul_ps(a2_1, h_5_2));
	v1 = _mm_add_ps(v1, _mm_mul_ps(a1_1, h_5_1));
	...
	__m128 a1_2 = _mm_load_ps(&q[(ldq*5)+4]);
	__m128 a2_2 = _mm_load_ps(&q[(ldq*4)+4]);
	__m128 a3_2 = _mm_load_ps(&q[(ldq*3)+4]);
	__m128 a4_2 = _mm_load_ps(&q[(ldq*2)+4]);
	__m128 a5_2 = _mm_load_ps(&q[(ldq)+4]);
	__m128 a6_2 = _mm_load_ps(&q[4]);

	register __m128 t2 = _mm_add_ps(a6_2, _mm_mul_ps(a5_2, h_6_5));
	t2 = _mm_add_ps(t2, _mm_mul_ps(a4_2, h_6_4));
	t2 = _mm_add_ps(t2, _mm_mul_ps(a3_2, h_6_3));
	t2 = _mm_add_ps(t2, _mm_mul_ps(a2_2, h_6_2));
	t2 = _mm_add_ps(t2, _mm_mul_ps(a1_2, h_6_1));
	register __m128 v2 = _mm_add_ps(a5_2, _mm_mul_ps(a4_2, h_5_4));
	v2 = _mm_add_ps(v2, _mm_mul_ps(a3_2, h_5_3));
	v2 = _mm_add_ps(v2, _mm_mul_ps(a2_2, h_5_2));
	v2 = _mm_add_ps(v2, _mm_mul_ps(a1_2, h_5_1));
	...
	for(i = 6; i < nb; i++)
	{
		h1 = _mm_moveldup_ps( _mm_castpd_ps(_mm_loaddup_pd( (double *)&hh[i-5])) );
//		h1 = _mm_loaddup_pd(&hh[i-5]);
		...
		h2 = _mm_moveldup_ps( _mm_castpd_ps(_mm_loaddup_pd( (double *)&hh[ldh+i-4])) );
//		h2 = _mm_loaddup_pd(&hh[ldh+i-4]);
		...
		h3 = _mm_moveldup_ps( _mm_castpd_ps(_mm_loaddup_pd( (double *)&hh[(ldh*2)+i-3])) );
//		h3 = _mm_loaddup_pd(&hh[(ldh*2)+i-3]);

		z1 = _mm_add_ps(z1, _mm_mul_ps(q1,h3));
		z2 = _mm_add_ps(z2, _mm_mul_ps(q2,h3));

		h4 = _mm_moveldup_ps( _mm_castpd_ps(_mm_loaddup_pd( (double *)&hh[(ldh*3)+i-2])) );
//		h4 = _mm_loaddup_pd(&hh[(ldh*3)+i-2]);

		w1 = _mm_add_ps(w1, _mm_mul_ps(q1,h4));
		w2 = _mm_add_ps(w2, _mm_mul_ps(q2,h4));

		h5 = _mm_moveldup_ps( _mm_castpd_ps(_mm_loaddup_pd( (double *)&hh[(ldh*4)+i-1])) );
//		h5 = _mm_loaddup_pd(&hh[(ldh*4)+i-1]);

		v1 = _mm_add_ps(v1, _mm_mul_ps(q1,h5));
		v2 = _mm_add_ps(v2, _mm_mul_ps(q2,h5));


		h6 = _mm_moveldup_ps( _mm_castpd_ps(_mm_loaddup_pd( (double *)&hh[(ldh*5)+i])) );
//		h6 = _mm_loaddup_pd(&hh[(ldh*5)+i]);

		t1 = _mm_add_ps(t1, _mm_mul_ps(q1,h6));
		t2 = _mm_add_ps(t2, _mm_mul_ps(q2,h6));
	}

        h1 = _mm_moveldup_ps( _mm_castpd_ps(_mm_loaddup_pd( (double *)&hh[nb-5])) );
//	h1 = _mm_loaddup_pd(&hh[nb-5]);
	...
	x2 = _mm_add_ps(x2, _mm_mul_ps(q2,h1));
        ...
        h2 = _mm_moveldup_ps( _mm_castpd_ps(_mm_loaddup_pd( (double *)&hh[ldh+nb-4])) );
//	h2 = _mm_loaddup_pd(&hh[ldh+nb-4]);

	y1 = _mm_add_ps(y1, _mm_mul_ps(q1,h2));
	y2 = _mm_add_ps(y2, _mm_mul_ps(q2,h2));

        h3 = _mm_moveldup_ps( _mm_castpd_ps(_mm_loaddup_pd( (double *)&hh[(ldh*2)+nb-3])) );
//	h3 = _mm_loaddup_pd(&hh[(ldh*2)+nb-3]);

	z1 = _mm_add_ps(z1, _mm_mul_ps(q1,h3));
	z2 = _mm_add_ps(z2, _mm_mul_ps(q2,h3));

        h4 = _mm_moveldup_ps( _mm_castpd_ps(_mm_loaddup_pd( (double *)&hh[(ldh*3)+nb-2])) );
//	h4 = _mm_loaddup_pd(&hh[(ldh*3)+nb-2]);

	w1 = _mm_add_ps(w1, _mm_mul_ps(q1,h4));
	w2 = _mm_add_ps(w2, _mm_mul_ps(q2,h4));

        h5 = _mm_moveldup_ps( _mm_castpd_ps(_mm_loaddup_pd( (double *)&hh[(ldh*4)+nb-1])) );
//	h5 = _mm_loaddup_pd(&hh[(ldh*4)+nb-1]);

	v1 = _mm_add_ps(v1, _mm_mul_ps(q1,h5));
	v2 = _mm_add_ps(v2, _mm_mul_ps(q2,h5));

        h1 = _mm_moveldup_ps( _mm_castpd_ps(_mm_loaddup_pd( (double *)&hh[nb-4])) );
//	h1 = _mm_loaddup_pd(&hh[nb-4]);
	...
	x2 = _mm_add_ps(x2, _mm_mul_ps(q2,h1));
        ...
        h2 = _mm_moveldup_ps( _mm_castpd_ps(_mm_loaddup_pd( (double *)&hh[ldh+nb-3])) );
//	h2 = _mm_loaddup_pd(&hh[ldh+nb-3]);
	...
	y2 = _mm_add_ps(y2, _mm_mul_ps(q2,h2));
        ...
        h3 = _mm_moveldup_ps( _mm_castpd_ps(_mm_loaddup_pd( (double *)&hh[(ldh*2)+nb-2])) );
//	h3 = _mm_loaddup_pd(&hh[(ldh*2)+nb-2]);

	z1 = _mm_add_ps(z1, _mm_mul_ps(q1,h3));
	z2 = _mm_add_ps(z2, _mm_mul_ps(q2,h3));

        h4 = _mm_moveldup_ps( _mm_castpd_ps(_mm_loaddup_pd( (double *)&hh[(ldh*3)+nb-1])) );
...
//	h1 = _mm_loaddup_pd(&hh[nb-2]);
	q1 = _mm_load_ps(&q[(nb+3)*ldq]);
	q2 = _mm_load_ps(&q[((nb+3)*ldq)+4]);
...
//	h1 = _mm_loaddup_pd(&hh[nb-1]);
	q1 = _mm_load_ps(&q[(nb+4)*ldq]);
	q2 = _mm_load_ps(&q[((nb+4)*ldq)+4]);
...
//	__m128d tau1 = _mm_loaddup_pd(&hh[0]);
	x1 = _mm_mul_ps(x1, tau1);
	x2 = _mm_mul_ps(x2, tau1);

        __m128 tau2 = _mm_moveldup_ps( _mm_castpd_ps(_mm_loaddup_pd( (double *)&hh[ldh])) );
//	__m128d tau2 = _mm_loaddup_pd(&hh[ldh]);
        __m128 vs_1_2 = _mm_moveldup_ps( _mm_castpd_ps(_mm_loaddup_pd( (double *)&scalarprods[0])) );
//	__m128d vs_1_2 = _mm_loaddup_pd(&scalarprods[0]);
	h2 = _mm_mul_ps(tau2, vs_1_2);

	y1 = _mm_sub_ps(_mm_mul_ps(y1,tau2), _mm_mul_ps(x1,h2));
	y2 = _mm_sub_ps(_mm_mul_ps(y2,tau2), _mm_mul_ps(x2,h2));

        __m128 tau3 = _mm_moveldup_ps( _mm_castpd_ps(_mm_loaddup_pd( (double *)&hh[ldh*2])) );
//	__m128d tau3 = _mm_loaddup_pd(&hh[ldh*2]);
        __m128 vs_1_3 = _mm_moveldup_ps( _mm_castpd_ps(_mm_loaddup_pd( (double *)&scalarprods[1])) );
//	__m128d vs_1_3 = _mm_loaddup_pd(&scalarprods[1]);
        __m128 vs_2_3 = _mm_moveldup_ps( _mm_castpd_ps(_mm_loaddup_pd( (double *)&scalarprods[2])) );
//	__m128d vs_2_3 = _mm_loaddup_pd(&scalarprods[2]);
	h2 = _mm_mul_ps(tau3, vs_1_3);
	h3 = _mm_mul_ps(tau3, vs_2_3);

	z1 = _mm_sub_ps(_mm_mul_ps(z1,tau3), _mm_add_ps(_mm_mul_ps(y1,h3), _mm_mul_ps(x1,h2)));
	z2 = _mm_sub_ps(_mm_mul_ps(z2,tau3), _mm_add_ps(_mm_mul_ps(y2,h3), _mm_mul_ps(x2,h2)));

        __m128 tau4 = _mm_moveldup_ps( _mm_castpd_ps(_mm_loaddup_pd( (double *)&hh[ldh*3])) );
//	__m128d tau4 = _mm_loaddup_pd(&hh[ldh*3]);
        __m128 vs_1_4 = _mm_moveldup_ps( _mm_castpd_ps(_mm_loaddup_pd( (double *)&scalarprods[3])) );
//	__m128d vs_1_4 = _mm_loaddup_pd(&scalarprods[3]);
        __m128 vs_2_4 = _mm_moveldup_ps( _mm_castpd_ps(_mm_loaddup_pd( (double *)&scalarprods[4])) );
//	__m128d vs_2_4 = _mm_loaddup_pd(&scalarprods[4]);
	h2 = _mm_mul_ps(tau4, vs_1_4);
	h3 = _mm_mul_ps(tau4, vs_2_4);

	__m128 vs_3_4 = _mm_moveldup_ps( _mm_castpd_ps(_mm_loaddup_pd( (double *)&scalarprods[5])) );
//	__m128d vs_3_4 = _mm_loaddup_pd(&scalarprods[5]);
	h4 = _mm_mul_ps(tau4, vs_3_4);

	w1 = _mm_sub_ps(_mm_mul_ps(w1,tau4), _mm_add_ps(_mm_mul_ps(z1,h4), _mm_add_ps(_mm_mul_ps(y1,h3), _mm_mul_ps(x1,h2))));
	w2 = _mm_sub_ps(_mm_mul_ps(w2,tau4), _mm_add_ps(_mm_mul_ps(z2,h4), _mm_add_ps(_mm_mul_ps(y2,h3), _mm_mul_ps(x2,h2))));

        __m128 tau5 = _mm_moveldup_ps( _mm_castpd_ps(_mm_loaddup_pd( (double *)&hh[ldh*4])) );
//	__m128d tau5 = _mm_loaddup_pd(&hh[ldh*4]);
	__m128 vs_1_5 = _mm_moveldup_ps( _mm_castpd_ps(_mm_loaddup_pd( (double *)&scalarprods[6])) );
//	__m128d vs_1_5 = _mm_loaddup_pd(&scalarprods[6]);
	__m128 vs_2_5 = _mm_moveldup_ps( _mm_castpd_ps(_mm_loaddup_pd( (double *)&scalarprods[7])) );
//	__m128d vs_2_5 = _mm_loaddup_pd(&scalarprods[7]);
	h2 = _mm_mul_ps(tau5, vs_1_5);
	h3 = _mm_mul_ps(tau5, vs_2_5);

	__m128 vs_3_5 = _mm_moveldup_ps( _mm_castpd_ps(_mm_loaddup_pd( (double *)&scalarprods[8])) );
//	__m128d vs_3_5 = _mm_loaddup_pd(&scalarprods[8]);
	__m128 vs_4_5 = _mm_moveldup_ps( _mm_castpd_ps(_mm_loaddup_pd( (double *)&scalarprods[9])) );
//	__m128d vs_4_5 = _mm_loaddup_pd(&scalarprods[9]);

	h4 = _mm_mul_ps(tau5, vs_3_5);
	h5 = _mm_mul_ps(tau5, vs_4_5);

	v1 = _mm_sub_ps(_mm_mul_ps(v1,tau5), _mm_add_ps(_mm_add_ps(_mm_mul_ps(w1,h5), _mm_mul_ps(z1,h4)), _mm_add_ps(_mm_mul_ps(y1,h3), _mm_mul_ps(x1,h2))));
	v2 = _mm_sub_ps(_mm_mul_ps(v2,tau5), _mm_add_ps(_mm_add_ps(_mm_mul_ps(w2,h5), _mm_mul_ps(z2,h4)), _mm_add_ps(_mm_mul_ps(y2,h3), _mm_mul_ps(x2,h2))));

        __m128 tau6 = _mm_moveldup_ps( _mm_castpd_ps(_mm_loaddup_pd( (double *)&hh[ldh*5])) );
//	__m128d tau6 = _mm_loaddup_pd(&hh[ldh*5]);
	__m128 vs_1_6 = _mm_moveldup_ps( _mm_castpd_ps(_mm_loaddup_pd( (double *)&scalarprods[10])) );
//	__m128d vs_1_6 = _mm_loaddup_pd(&scalarprods[10]);
	__m128 vs_2_6 = _mm_moveldup_ps( _mm_castpd_ps(_mm_loaddup_pd( (double *)&scalarprods[11])) );
//	__m128d vs_2_6 = _mm_loaddup_pd(&scalarprods[11]);

	h2 = _mm_mul_ps(tau6, vs_1_6);
	h3 = _mm_mul_ps(tau6, vs_2_6);

	__m128 vs_3_6 = _mm_moveldup_ps( _mm_castpd_ps(_mm_loaddup_pd( (double *)&scalarprods[12])) );
//	__m128d vs_3_6 = _mm_loaddup_pd(&scalarprods[12]);
	__m128 vs_4_6 = _mm_moveldup_ps( _mm_castpd_ps(_mm_loaddup_pd( (double *)&scalarprods[13])) );
//	__m128d vs_4_6 = _mm_loaddup_pd(&scalarprods[13]);
	__m128 vs_5_6 = _mm_moveldup_ps( _mm_castpd_ps(_mm_loaddup_pd( (double *)&scalarprods[14])) );
//	__m128d vs_5_6 = _mm_loaddup_pd(&scalarprods[14]);

	h4 = _mm_mul_ps(tau6, vs_3_6);
	h5 = _mm_mul_ps(tau6, vs_4_6);
	h6 = _mm_mul_ps(tau6, vs_5_6);

	t1 = _mm_sub_ps(_mm_mul_ps(t1,tau6), _mm_add_ps( _mm_mul_ps(v1,h6), _mm_add_ps(_mm_add_ps(_mm_mul_ps(w1,h5), _mm_mul_ps(z1,h4)), _mm_add_ps(_mm_mul_ps(y1,h3), _mm_mul_ps(x1,h2)))));
	t2 = _mm_sub_ps(_mm_mul_ps(t2,tau6), _mm_add_ps( _mm_mul_ps(v2,h6), _mm_add_ps(_mm_add_ps(_mm_mul_ps(w2,h5), _mm_mul_ps(z2,h4)), _mm_add_ps(_mm_mul_ps(y2,h3), _mm_mul_ps(x2,h2)))));
	...
	h6 = _mm_moveldup_ps( _mm_castpd_ps(_mm_loaddup_pd( (double *)&hh[(ldh*5)+1])) );
//	h6 = _mm_loaddup_pd(&hh[(ldh*5)+1]);
	...
	q1 = _mm_sub_ps(q1, _mm_mul_ps(t1, h6));
	q2 = _mm_sub_ps(q2, _mm_mul_ps(t2, h6));

	_mm_store_ps(&q[ldq],q1);
	_mm_store_ps(&q[(ldq+4)],q2);

	h5 = _mm_moveldup_ps( _mm_castpd_ps(_mm_loaddup_pd( (double *)&hh[(ldh*4)+1])) );
//	h5 = _mm_loaddup_pd(&hh[(ldh*4)+1]);
	q1 = _mm_load_ps(&q[ldq*2]);
	q2 = _mm_load_ps(&q[(ldq*2)+4]);
	q1 = _mm_sub_ps(q1, w1);
	q2 = _mm_sub_ps(q2, w2);
	q1 = _mm_sub_ps(q1, _mm_mul_ps(v1, h5));
	q2 = _mm_sub_ps(q2, _mm_mul_ps(v2, h5));

	h6 = _mm_moveldup_ps( _mm_castpd_ps(_mm_loaddup_pd( (double *)&hh[(ldh*5)+2])) );
...
//	h4 = _mm_loaddup_pd(&hh[(ldh*3)+1]);
	...
	h5 = _mm_moveldup_ps( _mm_castpd_ps(_mm_loaddup_pd( (double *)&hh[(ldh*4)+2])) );
//	h5 = _mm_loaddup_pd(&hh[(ldh*4)+2]);

	q1 = _mm_sub_ps(q1, _mm_mul_ps(v1, h5));
	q2 = _mm_sub_ps(q2, _mm_mul_ps(v2, h5));

	h6 = _mm_moveldup_ps( _mm_castpd_ps(_mm_loaddup_pd( (double *)&hh[(ldh*5)+3])) );
...
//	h4 = _mm_loaddup_pd(&hh[(ldh*3)+2]);
	...
	h5 = _mm_moveldup_ps( _mm_castpd_ps(_mm_loaddup_pd( (double *)&hh[(ldh*4)+3])) );
//	h5 = _mm_loaddup_pd(&hh[(ldh*4)+3]);

	q1 = _mm_sub_ps(q1, _mm_mul_ps(v1, h5));
	q2 = _mm_sub_ps(q2, _mm_mul_ps(v2, h5));

	h6 = _mm_moveldup_ps( _mm_castpd_ps(_mm_loaddup_pd( (double *)&hh[(ldh*5)+4])) );
//	h6 = _mm_loaddup_pd(&hh[(ldh*5)+4]);

	q1 = _mm_sub_ps(q1, _mm_mul_ps(t1, h6));
	q2 = _mm_sub_ps(q2, _mm_mul_ps(t2, h6));

	_mm_store_ps(&q[ldq*4],q1);
	_mm_store_ps(&q[(ldq*4)+4],q2);

	h2 = _mm_moveldup_ps( _mm_castpd_ps(_mm_loaddup_pd( (double *)&hh[(ldh)+1])) );
//	h2 = _mm_loaddup_pd(&hh[(ldh)+1]);

	q1 = _mm_load_ps(&q[ldq*5]);
	q2 = _mm_load_ps(&q[(ldq*5)+4]);
	q1 = _mm_sub_ps(q1, x1);
	q2 = _mm_sub_ps(q2, x2);
...
//	h4 = _mm_loaddup_pd(&hh[(ldh*3)+3]);
	...
	h5 = _mm_moveldup_ps( _mm_castpd_ps(_mm_loaddup_pd( (double *)&hh[(ldh*4)+4])) );
//	h5 = _mm_loaddup_pd(&hh[(ldh*4)+4]);

	q1 = _mm_sub_ps(q1, _mm_mul_ps(v1, h5));
	q2 = _mm_sub_ps(q2, _mm_mul_ps(v2, h5));

	h6 = _mm_moveldup_ps( _mm_castpd_ps(_mm_loaddup_pd( (double *)&hh[(ldh*5)+5])) );
//	h6 = _mm_loaddup_pd(&hh[(ldh*5)+5]);

	q1 = _mm_sub_ps(q1, _mm_mul_ps(t1, h6));
	q2 = _mm_sub_ps(q2, _mm_mul_ps(t2, h6));

	_mm_store_ps(&q[ldq*5],q1);
	_mm_store_ps(&q[(ldq*5)+4],q2);
...
//	h2 = _mm_loaddup_pd(&hh[ldh+nb-1]);
	...
	_mm_store_ps(&q[(nb+3)*ldq],q1);
	_mm_store_ps(&q[((nb+3)*ldq)+4],q2);
...
//	h1 = _mm_loaddup_pd(&hh[nb-1]);
	...
	_mm_store_ps(&q[(nb+4)*ldq],q1);
	_mm_store_ps(&q[((nb+4)*ldq)+4],q2);
}
