...
!-------------------------------------------------------------------------------
  ...
  contains
!-------------------------------------------------------------------------------
!>  \brief solve_evp_real_double: Fortran function to solve the real eigenvalue
...
!-------------------------------------------------------------------------------
!>  \brief solve_evp_complex_double: Fortran function to solve the complex eigenvalue
!>         problem with either the ELPA 1stage or the ELPA 2stage solver
!>
!>  Parameters
!>
...
#ifdef WANT_SINGLE_PRECISION_COMPLEX
!-------------------------------------------------------------------------------
!>  \brief solve_evp_complex_single: Fortran function to solve the complex eigenvalue
!>         problem with either the ELPA 1stage or the ELPA 2stage solver
!>
!>  Parameters
!>
