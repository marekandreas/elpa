...
module tridiag_cuda
  ...
  interface
    subroutine cuda_dot_product_double_c(n, x_dev, incx, y_dev, incy, result_dev, wantDebug, sm_count, my_stream) &
  ...
  interface
    subroutine cuda_dot_product_float_c(n, x_dev, incx, y_dev, incy, result_dev, wantDebug, sm_count, my_stream) &
  ...
  interface
    subroutine cuda_dot_product_double_complex_c(n, x_dev, incx, y_dev, incy, result_dev, wantDebug, sm_count, my_stream) &
  ...
  interface
    subroutine cuda_dot_product_float_complex_c(n, x_dev, incx, y_dev, incy, result_dev, wantDebug, sm_count, my_stream) &
...
#ifdef WITH_NVIDIA_GPU_VERSION
      call cuda_dot_product_double_c(n, x_dev, incx, y_dev, incy, result_dev, wantDebug, sm_count, my_stream)
#endif
...
#ifdef WITH_NVIDIA_GPU_VERSION
      call cuda_dot_product_float_c(n, x_dev, incx, y_dev, incy, result_dev, wantDebug, sm_count, my_stream)
#endif
...
#ifdef WITH_NVIDIA_GPU_VERSION
      call cuda_dot_product_double_complex_c(n, x_dev, incx, y_dev, incy, result_dev, wantDebug, sm_count, my_stream)
#endif
...
#ifdef WITH_NVIDIA_GPU_VERSION
      call cuda_dot_product_float_complex_c(n, x_dev, incx, y_dev, incy, result_dev, wantDebug, sm_count, my_stream)
#endif
