...
__global__ void hip_distribute_global_column_double_kernel(double *g_col, const int g_col_dim1, const int g_col_dim2, double *l_col, const int ldq, const int matrixCols, const int noff_in, const int noff, const int nlen, const int my_prow, const int np_rows, const int nblk) {
...
extern "C" void hip_distribute_global_column_double_FromC(double *g_col_dev, int *g_col_dim1_in, int *g_col_dim2_in,  double *l_col_dev, int *ldq_in, int *matrixCols_in, int *noff_in_in, int *noff_in, int *nlen_in, int * my_prow_in, int *np_rows_in, int *nblk_in, hipStream_t  my_stream){
  ...
  hip_distribute_global_column_double_kernel<<<blocks, threadsPerBlock, 0, my_stream>>>(g_col_dev, g_col_dim1, g_col_dim2, l_col_dev, ldq, matrixCols, noffin, noff, nlen, my_prow, np_rows, nblk);
#else
  hip_distribute_global_column_double_kernel<<<blocks, threadsPerBlock>>>(g_col_dev, g_col_dim1, g_col_dim2, l_col_dev, ldq, matrixCols, noffin, noff, nlen, my_prow, np_rows, nblk);
#endif

  hipError_t cuerr = hipGetLastError();
  if (cuerr != hipSuccess){
    printf("Error in executing hip_distribute_global_column_double_kernel: %s\n",hipGetErrorString(cuerr));
  }
}


__global__ void hip_distribute_global_column_float_kernel(float *g_col, const int g_col_dim1, const int g_col_dim2, float *l_col, const int ldq, const int matrixCols, const int noff_in, const int noff, const int nlen, const int my_prow, const int np_rows, const int nblk) {
...
extern "C" void hip_distribute_global_column_float_FromC(float *g_col_dev, int *g_col_dim1_in, int *g_col_dim2_in,  float *l_col_dev, int *ldq_in, int *matrixCols_in, int *noff_in_in, int *noff_in, int *nlen_in, int * my_prow_in, int *np_rows_in, int *nblk_in, hipStream_t  my_stream){
...
#ifdef WITH_GPU_STREAMS
  hip_distribute_global_column_float_kernel<<<blocks, threadsPerBlock, 0, my_stream>>>(g_col_dev, g_col_dim1, g_col_dim2, l_col_dev, ldq, matrixCols, noffin, noff, nlen, my_prow, np_rows, nblk);
#else
  hip_distribute_global_column_float_kernel<<<blocks, threadsPerBlock>>>(g_col_dev, g_col_dim1, g_col_dim2, l_col_dev, ldq, matrixCols, noffin, noff, nlen, my_prow, np_rows, nblk);
#endif

  hipError_t cuerr = hipGetLastError();
  if (cuerr != hipSuccess){
    printf("Error in executing hip_distribute_global_column_float_kernel: %s\n",hipGetErrorString(cuerr));
  }
}
