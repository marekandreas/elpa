...
module elpa1_cuda
  ...
  interface
    subroutine cuda_dot_product_double_complex_c(n, x_dev, incx, y_dev, incy, result_dev, wantDebug, my_stream) &
  ...
  interface
    subroutine cuda_dot_product_and_assign_double_complex_c(v_row_dev, l_rows, isOurProcessRow, aux1_dev, wantDebug, my_stream) &
  ...
  interface
    subroutine cuda_dot_product_and_assign_float_complex_c(v_row_dev, l_rows, isOurProcessRow, aux1_dev, wantDebug, my_stream) &
  ...
  interface
    subroutine cuda_set_e_vec_scale_set_one_store_v_row_double_complex_c(e_vec_dev, vrl_dev, a_dev, & 
  ...
  interface
    subroutine cuda_set_e_vec_scale_set_one_store_v_row_float_complex_c(e_vec_dev, vrl_dev, a_dev, & 
                                                v_row_dev, tau_dev, xf_host_or_dev, &
                                                l_rows, l_cols, matrixRows, istep, isOurProcessRow, useCCL, wantDebug, my_stream) &
  ...
  interface
    subroutine cuda_hh_transform_double_complex_c(alpha_dev, xnorm_sq_dev, xf_dev, tau_dev, wantDebug, my_stream) &
  ...
  interface
    subroutine cuda_hh_transform_float_complex_c(alpha_dev, xnorm_sq_dev, xf_dev, tau_dev, wantDebug, my_stream) &
  ...
  subroutine cuda_dot_product_double_complex(n, x_dev, incx, y_dev, incy, result_dev, wantDebug, my_stream)
    use, intrinsic :: iso_c_binding
    implicit none
...
#ifdef WITH_NVIDIA_GPU_VERSION
    call cuda_dot_product_double_complex_c(n, x_dev, incx, y_dev, incy, result_dev, wantDebug, my_stream)
#endif
  end subroutine


  subroutine cuda_dot_product_float_complex(n, x_dev, incx, y_dev, incy, result_dev, wantDebug, my_stream)
    use, intrinsic :: iso_c_binding
    implicit none
...
#ifdef WITH_NVIDIA_GPU_VERSION
    call cuda_dot_product_float_complex_c(n, x_dev, incx, y_dev, incy, result_dev, wantDebug, my_stream)
#endif
  end subroutine
  ...
  subroutine cuda_dot_product_and_assign_double_complex(v_row_dev, l_rows, isOurProcessRow, aux1_dev, wantDebug, my_stream)
    use, intrinsic :: iso_c_binding
    implicit none
...
#ifdef WITH_NVIDIA_GPU_VERSION
    call cuda_dot_product_and_assign_double_complex_c(v_row_dev, l_rows, isOurProcessRow, aux1_dev, wantDebug, my_stream)
#endif
  end subroutine


  subroutine cuda_dot_product_and_assign_float_complex(v_row_dev, l_rows, isOurProcessRow, aux1_dev, wantDebug, my_stream)
    use, intrinsic :: iso_c_binding
    implicit none
...
#ifdef WITH_NVIDIA_GPU_VERSION
    call cuda_dot_product_and_assign_float_complex_c(v_row_dev, l_rows, isOurProcessRow, aux1_dev, wantDebug, my_stream)
#endif
  end subroutine
  ...
  subroutine cuda_set_e_vec_scale_set_one_store_v_row_double_complex(e_vec_dev, vrl_dev, a_dev, v_row_dev, tau_dev,xf_host_or_dev,&
                                                l_rows, l_cols, matrixRows, istep, isOurProcessRow, useCCL, wantDebug, my_stream)
    use, intrinsic :: iso_c_binding
    implicit none
...
#ifdef WITH_NVIDIA_GPU_VERSION
    call cuda_set_e_vec_scale_set_one_store_v_row_double_complex_c(e_vec_dev, vrl_dev, a_dev, v_row_dev, tau_dev, xf_host_or_dev, &
                                            l_rows, l_cols, matrixRows, istep, isOurProcessRow, useCCL, wantDebug, my_stream)
#endif
  end subroutine


  subroutine cuda_set_e_vec_scale_set_one_store_v_row_float_complex(e_vec_dev, vrl_dev, a_dev, v_row_dev, tau_dev, xf_host_or_dev, &
    l_rows, l_cols, matrixRows, istep, isOurProcessRow, useCCL, wantDebug, my_stream)
    use, intrinsic :: iso_c_binding
    implicit none
...
#ifdef WITH_NVIDIA_GPU_VERSION
    call cuda_set_e_vec_scale_set_one_store_v_row_float_complex_c(e_vec_dev, vrl_dev, a_dev, v_row_dev, tau_dev, xf_host_or_dev, &
                                            l_rows, l_cols, matrixRows, istep, isOurProcessRow, useCCL, wantDebug, my_stream)
#endif
  end subroutine
...
#ifdef WITH_NVIDIA_GPU_VERSION
    call cuda_hh_transform_double_complex_c(alpha_dev, xnorm_sq_dev, xf_dev, tau_dev, wantDebug, my_stream)
#endif
  end subroutine
...
#ifdef WITH_NVIDIA_GPU_VERSION
    call cuda_hh_transform_float_complex_c(alpha_dev, xnorm_sq_dev, xf_dev, tau_dev, wantDebug, my_stream)
#endif
  end subroutine
