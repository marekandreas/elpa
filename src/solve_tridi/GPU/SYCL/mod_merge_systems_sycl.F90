...
module merge_systems_sycl
  ...
  interface
    subroutine sycl_fill_ev_double_c(ev_dev, d1u_dev, dbase_dev, ddiff_dev, zu_dev, ev_scale_dev, idxq1_dev, &
...
#ifdef WANT_SINGLE_PRECISION_REAL
  interface
    subroutine sycl_fill_ev_float_c(ev_dev, d1u_dev, dbase_dev, ddiff_dev, zu_dev, ev_scale_dev, idxq1_dev, &
                                           idx_dev, na, gemm_dim_l, gemm_dim_m, nnzu, ns, &
                                           ncnt, my_stream) &
  ...
  contains
    ...
    subroutine sycl_fill_ev_double(ev_dev, d1u_dev, dbase_dev, ddiff_dev, zu_dev, ev_scale_dev, idxq1_dev, &
                                               idx_dev, na, gemm_dim_l, gemm_dim_m, nnzu, ns, &
                                               ncnt,  my_stream)
      use, intrinsic :: iso_c_binding
...
#ifdef WITH_SYCL_GPU_VERSION
      if (present(my_stream)) then
        call sycl_fill_ev_double_c(ev_dev, d1u_dev, dbase_dev, ddiff_dev, zu_dev, ev_scale_dev, idxq1_dev,  &
                                                  idx_dev, na, gemm_dim_l, gemm_dim_m, nnzu, ns, &
                                                  ncnt, my_stream)
      else
        call sycl_fill_ev_double_c(ev_dev, d1u_dev, dbase_dev, ddiff_dev, zu_dev, ev_scale_dev, idxq1_dev,  &
...
#ifdef WANT_SINGLE_PRECISION_REAL
    subroutine sycl_fill_ev_float(ev_dev, d1u_dev, dbase_dev, ddiff_dev, zu_dev, ev_scale_dev, idxq1_dev, &
                                               idx_dev, na, gemm_dim_l, gemm_dim_m, nnzu, ns, &
                                               ncnt,  my_stream)
      use, intrinsic :: iso_c_binding
...
#ifdef WITH_SYCL_GPU_VERSION
      if (present(my_stream)) then
        call sycl_fill_ev_float_c(ev_dev, d1u_dev, dbase_dev, ddiff_dev, zu_dev, ev_scale_dev, idxq1_dev,  &
                                                  idx_dev, na, gemm_dim_l, gemm_dim_m, nnzu, ns, &
                                                  ncnt, my_stream)
      else
        call sycl_fill_ev_float_c(ev_dev, d1u_dev, dbase_dev, ddiff_dev, zu_dev, ev_scale_dev, idxq1_dev,  &
