...
module multiply_a_b_hip
  ...
  interface
    subroutine hip_copy_double_tmp2_c_intptr_c(tmp2_dev, c_dev, nr_done, nstor, lcs, lce, &
                                                                     ldc, ldcCols, my_stream)&
                                                     bind(C, name="hip_copy_double_tmp2_c_FromC")
      use, intrinsic :: iso_c_binding
      implicit none
  ...
  interface
    subroutine hip_copy_double_tmp2_c_cptr_c(tmp2_dev, c_dev, nr_done, nstor, lcs, lce, &
                                                                     ldc, ldcCols, my_stream)&
                                                     bind(C, name="hip_copy_double_tmp2_c_FromC")
      use, intrinsic :: iso_c_binding
      implicit none
  ...
  interface
    subroutine hip_copy_float_tmp2_c_intptr_c(tmp2_dev, c_dev, nr_done, nstor, lcs, lce, &
                                                                     ldc, ldcCols, my_stream)&
                                                     bind(C, name="hip_copy_float_tmp2_c_FromC")
      use, intrinsic :: iso_c_binding
      implicit none
      integer(kind=C_intptr_T), value  :: tmp2_dev, c_dev
      integer(kind=c_int), intent(in)  :: nr_done, nstor, lcs, lce, ldc, ldcCols
  ...
  interface
    subroutine hip_copy_float_tmp2_c_cptr_c(tmp2_dev, c_dev, nr_done, nstor, lcs, lce, &
                                                                     ldc, ldcCols, my_stream)&
                                                     bind(C, name="hip_copy_float_tmp2_c_FromC")
      use, intrinsic :: iso_c_binding
      implicit none
  ...
  interface
    subroutine hip_copy_double_complex_tmp2_c_intptr_c(tmp2_dev, c_dev, nr_done, nstor, lcs, lce, &
                                                                     ldc, ldcCols, my_stream)&
                                                     bind(C, name="hip_copy_double_complex_tmp2_c_FromC")
      use, intrinsic :: iso_c_binding
      implicit none
      integer(kind=C_intptr_T), value  :: tmp2_dev, c_dev
      integer(kind=c_int), intent(in)  :: nr_done, nstor, lcs, lce, ldc, ldcCols
  ...
  interface
    subroutine hip_copy_double_complex_tmp2_c_cptr_c(tmp2_dev, c_dev, nr_done, nstor, lcs, lce, &
                                                                     ldc, ldcCols, my_stream)&
                                                     bind(C, name="hip_copy_double_complex_tmp2_c_FromC")
      use, intrinsic :: iso_c_binding
      implicit none
  ...
  interface
    subroutine hip_copy_float_complex_tmp2_c_intptr_c(tmp2_dev, c_dev, nr_done, nstor, lcs, lce, &
                                                                     ldc, ldcCols, my_stream)&
                                                     bind(C, name="hip_copy_float_complex_tmp2_c_FromC")
      use, intrinsic :: iso_c_binding
      implicit none
      integer(kind=C_intptr_T), value  :: tmp2_dev, c_dev
      integer(kind=c_int), intent(in)  :: nr_done, nstor, lcs, lce, ldc, ldcCols
  ...
  interface
    subroutine hip_copy_float_complex_tmp2_c_cptr_c(tmp2_dev, c_dev, nr_done, nstor, lcs, lce, &
                                                                     ldc, ldcCols, my_stream)&
                                                     bind(C, name="hip_copy_float_complex_tmp2_c_FromC")
      use, intrinsic :: iso_c_binding
      implicit none
  ...
  interface
    subroutine hip_copy_aux_full_c(dataType, lhs_dev, rhs_dev, l_rows, l_cols, lld_lhs, lld_rhs, debug, my_stream) &
  ...
  interface
    subroutine hip_copy_and_set_zeros_aux_full_c(dataType, mat_dev, aux_mat_full_dev, &
  ...
  interface
    subroutine hip_copy_and_set_zeros_aux_a_full_c(dataType, mat_dev, aux_mat_full_dev, l_rows, l_cols, nblk_mult, &
  ...
  interface
    subroutine hip_copy_and_set_zeros_aux_b_full_c(dataType, mat_dev, aux_mat_full_dev, l_rows, l_cols, nblk_mult, &
  ...
  interface
    subroutine hip_ccl_copy_buf_send_c(dataType, a_dev, buf_send_dev, l_rows, l_cols, lld_buf, &
  ...
  interface
    subroutine hip_ccl_copy_buf_recv_c(dataType, at_col_dev, buf_recv_dev, l_rows, l_cols, lld_buf, &
                                        nblk, i_block_loc_fine_max, j_block_loc_fine_max, np_fine, np_bc_fine, &
                                        np_rows_fine, np_cols_fine, np_rows, np_cols, SM_count, debug, my_stream) &
  ...
  interface
    subroutine hip_copy_and_set_zeros_aux_ab_full_tn_nt_c(dataType,  a_transposed, &
  ...
  interface
    subroutine hip_update_c_tn_nt_c(dataType, a_transposed, &
  ...
  contains
    ...
    subroutine hip_copy_double_tmp2_c_intptr(tmp2_dev, c_dev, nr_done, nstor, lcs, lce, ldc, &
                                                              ldcCols, my_stream)
      use, intrinsic :: iso_c_binding
      ...
      call hip_copy_double_tmp2_c_intptr_c(tmp2_dev, c_dev, nr_done, nstor, lcs, &
                                                                lce, ldc, ldcCols, my_stream)
#endif
    end subroutine

    subroutine hip_copy_double_tmp2_c_cptr(tmp2_dev, c_dev, nr_done, nstor, lcs, lce, ldc, &
                                                              ldcCols, my_stream)
      use, intrinsic :: iso_c_binding
...
#ifdef WITH_AMD_GPU_VERSION
      call hip_copy_double_tmp2_c_cptr_c(tmp2_dev, c_dev, nr_done, nstor, lcs, &
                                                                lce, ldc, ldcCols, my_stream)
#endif
    end subroutine
...
#ifdef WITH_AMD_GPU_VERSION
      call hip_copy_double_a_aux_bc_intptr_c(a_dev, aux_bc_dev, n_aux_bc, nvals, lrs, lre, &
...
#ifdef WITH_AMD_GPU_VERSION
      call hip_copy_double_a_aux_bc_cptr_c(a_dev, aux_bc_dev, n_aux_bc, nvals, lrs, lre, &
                                                                  noff, nblk, n, l_rows, lda, ldaCols, my_stream)
#endif
    end subroutine

    subroutine hip_copy_double_aux_bc_aux_mat( aux_bc_dev, aux_mat_dev, lrs, lre, nstor, n_aux_bc, nvals, &
...
#ifdef WITH_AMD_GPU_VERSION
      call hip_copy_double_aux_bc_aux_mat_c(aux_bc_dev, aux_mat_dev, lrs, lre, nstor, n_aux_bc, nvals, &
                                                                 l_rows, nblk, nblk_mult, my_stream)
#endif
    end subroutine

    subroutine hip_copy_float_tmp2_c_intptr(tmp2_dev, c_dev, nr_done, nstor, lcs, lce, ldc, &
                                                              ldcCols, my_stream)
      use, intrinsic :: iso_c_binding
...
#ifdef WITH_AMD_GPU_VERSION
      call hip_copy_float_tmp2_c_intptr_c(tmp2_dev, c_dev, nr_done, nstor, lcs, &
                                                                lce, ldc, ldcCols, my_stream)
#endif
    end subroutine

    subroutine hip_copy_float_tmp2_c_cptr(tmp2_dev, c_dev, nr_done, nstor, lcs, lce, ldc, &
                                                              ldcCols, my_stream)
      use, intrinsic :: iso_c_binding
...
#ifdef WITH_AMD_GPU_VERSION
      call hip_copy_float_tmp2_c_cptr_c(tmp2_dev, c_dev, nr_done, nstor, lcs, &
                                                                lce, ldc, ldcCols, my_stream)
#endif
    end subroutine
...
#ifdef WITH_AMD_GPU_VERSION
      call hip_copy_float_a_aux_bc_intptr_c(a_dev, aux_bc_dev, n_aux_bc, nvals, lrs, lre, &
                                                                  noff, nblk, n, l_rows, lda, ldaCols, my_stream)
#endif
    end subroutine
...
#ifdef WITH_AMD_GPU_VERSION
      call hip_copy_float_a_aux_bc_cptr_c(a_dev, aux_bc_dev, n_aux_bc, nvals, lrs, lre, &
                                                                  noff, nblk, n, l_rows, lda, ldaCols, my_stream)
#endif
    end subroutine

    subroutine hip_copy_float_aux_bc_aux_mat( aux_bc_dev, aux_mat_dev, lrs, lre, nstor, n_aux_bc, nvals, &
                                                              l_rows, nblk, nblk_mult, my_stream)
      use, intrinsic :: iso_c_binding
...
#ifdef WITH_AMD_GPU_VERSION
      call hip_copy_float_aux_bc_aux_mat_c(aux_bc_dev, aux_mat_dev, lrs, lre, nstor, n_aux_bc, nvals, &
                                                                 l_rows, nblk, nblk_mult, my_stream)
#endif
    end subroutine

    subroutine hip_copy_double_complex_tmp2_c_intptr(tmp2_dev, c_dev, nr_done, nstor, lcs, lce, ldc, &
                                                              ldcCols, my_stream)
      use, intrinsic :: iso_c_binding
...
#ifdef WITH_AMD_GPU_VERSION
      call hip_copy_double_complex_tmp2_c_intptr_c(tmp2_dev, c_dev, nr_done, nstor, lcs, &
                                                                lce, ldc, ldcCols, my_stream)
#endif
    end subroutine

    subroutine hip_copy_double_complex_tmp2_c_cptr(tmp2_dev, c_dev, nr_done, nstor, lcs, lce, ldc, &
                                                              ldcCols, my_stream)
      use, intrinsic :: iso_c_binding
...
#ifdef WITH_AMD_GPU_VERSION
      call hip_copy_double_complex_tmp2_c_cptr_c(tmp2_dev, c_dev, nr_done, nstor, lcs, &
                                                                lce, ldc, ldcCols, my_stream)
#endif
    end subroutine
...
#ifdef WITH_AMD_GPU_VERSION
      call hip_copy_double_complex_a_aux_bc_intptr_c(a_dev, aux_bc_dev, n_aux_bc, nvals, lrs, lre, &
                                                                  noff, nblk, n, l_rows, lda, ldaCols, my_stream)
#endif
    end subroutine
...
#ifdef WITH_AMD_GPU_VERSION
      call hip_copy_double_complex_a_aux_bc_cptr_c(a_dev, aux_bc_dev, n_aux_bc, nvals, lrs, lre, &
                                                                  noff, nblk, n, l_rows, lda, ldaCols, my_stream)
#endif
    end subroutine

    subroutine hip_copy_double_complex_aux_bc_aux_mat( aux_bc_dev, aux_mat_dev, lrs, lre, nstor, n_aux_bc, nvals, &
                                                              l_rows, nblk, nblk_mult, my_stream)
      use, intrinsic :: iso_c_binding
...
#ifdef WITH_AMD_GPU_VERSION
      call hip_copy_double_complex_aux_bc_aux_mat_c(aux_bc_dev, aux_mat_dev, lrs, lre, nstor, n_aux_bc, nvals, &
                                                                 l_rows, nblk, nblk_mult, my_stream)
#endif
    end subroutine

    subroutine hip_copy_float_complex_tmp2_c_intptr(tmp2_dev, c_dev, nr_done, nstor, lcs, lce, ldc, &
                                                              ldcCols, my_stream)
      use, intrinsic :: iso_c_binding
...
#ifdef WITH_AMD_GPU_VERSION
      call hip_copy_float_complex_tmp2_c_intptr_c(tmp2_dev, c_dev, nr_done, nstor, lcs, &
                                                                lce, ldc, ldcCols, my_stream)
#endif
    end subroutine

    subroutine hip_copy_float_complex_tmp2_c_cptr(tmp2_dev, c_dev, nr_done, nstor, lcs, lce, ldc, &
                                                              ldcCols, my_stream)
      use, intrinsic :: iso_c_binding
...
#ifdef WITH_AMD_GPU_VERSION
      call hip_copy_float_complex_tmp2_c_cptr_c(tmp2_dev, c_dev, nr_done, nstor, lcs, &
                                                                lce, ldc, ldcCols, my_stream)
#endif
    end subroutine
...
#ifdef WITH_AMD_GPU_VERSION
      call hip_copy_float_complex_a_aux_bc_intptr_c(a_dev, aux_bc_dev, n_aux_bc, nvals, lrs, lre, &
                                                                  noff, nblk, n, l_rows, lda, ldaCols, my_stream)
#endif
    end subroutine
...
#ifdef WITH_AMD_GPU_VERSION
      call hip_copy_float_complex_a_aux_bc_cptr_c(a_dev, aux_bc_dev, n_aux_bc, nvals, lrs, lre, &
                                                                  noff, nblk, n, l_rows, lda, ldaCols, my_stream)
#endif
    end subroutine

    subroutine hip_copy_float_complex_aux_bc_aux_mat( aux_bc_dev, aux_mat_dev, lrs, lre, nstor, n_aux_bc, nvals, &
                                                              l_rows, nblk, nblk_mult, my_stream)
      use, intrinsic :: iso_c_binding
...
#ifdef WITH_AMD_GPU_VERSION
      call hip_copy_float_complex_aux_bc_aux_mat_c(aux_bc_dev, aux_mat_dev, lrs, lre, nstor, n_aux_bc, nvals, &
                                                                 l_rows, nblk, nblk_mult, my_stream)
#endif
    end subroutine


    subroutine hip_copy_aux_full(dataType, lhs_dev, rhs_dev, l_rows, l_cols, lld_lhs, lld_rhs, debug, my_stream)
      use, intrinsic :: iso_c_binding
      implicit none
      character(1, c_char), value     :: dataType
      ...
      integer(kind=c_intptr_t)        :: my_stream
#ifdef WITH_AMD_GPU_VERSION
      call hip_copy_aux_full_c(dataType, lhs_dev, rhs_dev, l_rows, l_cols, lld_lhs, lld_rhs, debug, my_stream)
#endif
    end subroutine


    subroutine hip_copy_and_set_zeros_aux_full(dataType, mat_dev, aux_mat_full_dev, &
                                                l_rows, l_cols, nblk_mult, debug, my_stream)
      use, intrinsic :: iso_c_binding
      implicit none
      character(1, c_char), value     :: dataType
      ...
      integer(kind=c_intptr_t)        :: my_stream
#ifdef WITH_AMD_GPU_VERSION
      call hip_copy_and_set_zeros_aux_full_c(dataType, mat_dev, aux_mat_full_dev, &
                                              l_rows, l_cols, nblk_mult, debug, my_stream)
#endif
    end subroutine


    subroutine hip_copy_and_set_zeros_aux_a_full(dataType, mat_dev, aux_mat_full_dev, l_rows, l_cols, &
      ...
      integer(kind=c_intptr_t)        :: my_stream
#ifdef WITH_AMD_GPU_VERSION
      call hip_copy_and_set_zeros_aux_a_full_c(dataType, mat_dev, aux_mat_full_dev, l_rows, l_cols, &
                                                nblk_mult_cols, nblk, np_bc_fine, np_cols_fine, np_cols, debug, my_stream)
#endif
    end subroutine

    subroutine hip_copy_and_set_zeros_aux_b_full(dataType, mat_dev, aux_mat_full_dev, l_rows, l_cols, nblk_mult, &
                                                  nblk_mult_rows, nblk, np_fine, np_rows_fine, np_rows, &
                                                  SM_count, debug, my_stream)
      use, intrinsic :: iso_c_binding
      implicit none
      ...
      integer(kind=c_intptr_t)        :: my_stream
#ifdef WITH_AMD_GPU_VERSION
      call hip_copy_and_set_zeros_aux_b_full_c(dataType, mat_dev, aux_mat_full_dev, l_rows, l_cols, nblk_mult, &
                                                nblk_mult_rows, nblk, np_fine, np_rows_fine, np_rows, SM_count, debug, my_stream)
#endif
    end subroutine


    subroutine hip_ccl_copy_buf_send(dataType, a_dev, buf_send_dev, l_rows, l_cols, lld_buf, &
                                      nblk, i_block_loc_fine_max, j_block_loc_fine_max, np_fine, np_bc_fine, &
                                      np_rows_fine, np_cols_fine, np_rows, np_cols, SM_count, debug, my_stream)
      use, intrinsic :: iso_c_binding
      implicit none
...
#ifdef WITH_AMD_GPU_VERSION
      call hip_ccl_copy_buf_send_c(dataType, a_dev, buf_send_dev, l_rows, l_cols, lld_buf, &
                                    nblk, i_block_loc_fine_max, j_block_loc_fine_max, np_fine, np_bc_fine, &
                                    np_rows_fine, np_cols_fine, np_rows, np_cols, SM_count, debug, my_stream)
#endif
    end subroutine
    ...
    subroutine hip_ccl_copy_buf_recv(dataType, at_col_dev, buf_recv_dev, l_rows, l_cols, lld_buf, &
                                      nblk, i_block_loc_fine_max, j_block_loc_fine_max, np_fine, np_bc_fine, &
                                      np_rows_fine, np_cols_fine, np_rows, np_cols, SM_count, debug, my_stream)
      use, intrinsic :: iso_c_binding
      implicit none
...
#ifdef WITH_AMD_GPU_VERSION
      call hip_ccl_copy_buf_recv_c(dataType, at_col_dev, buf_recv_dev, l_rows, l_cols, &
    ...
    subroutine hip_copy_and_set_zeros_aux_ab_full_tn_nt(dataType,  a_transposed, &
                                                      a_dev, b_dev, aux_a_full_dev, aux_b_full_dev, &
                                                      l_rows, l_cols, nblk_mult_max, nblk_mult, nblk, &
                                                      np_ab_fine, np_rows, my_prow, &
                                                      np_t_fine , np_cols, my_pcol, &
    ...
    subroutine hip_update_c_tn_nt(dataType, a_transposed, &
                                  c_dev, tmp1_full_dev, beta_int, &
                                  l_rows, l_cols, nblk_mult_max, nblk_mult, nblk, &
                                  np_rows, np_cols, np_dirs_fine, &
                                  np_dirs_t, my_pdir_t, np_fine, &
