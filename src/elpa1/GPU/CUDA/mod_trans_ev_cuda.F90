...
module trans_ev_cuda
  ...
  interface
    subroutine cuda_set_tmat_diag_from_tau_c(dataType, tmat_dev, tau_dev, max_stored_rows, nstor, tau_offset, &
                                             SM_count, debug, my_stream) &
  ...
  contains
    ...
    subroutine cuda_set_tmat_diag_from_tau(dataType, tmat_dev, tau_dev, max_stored_rows, nstor, tau_offset, &
                                           SM_count, debug, my_stream)
      use, intrinsic :: iso_c_binding
      implicit none
      character(1, c_char), value     :: dataType
...
#ifdef WITH_NVIDIA_GPU_VERSION
      call cuda_set_tmat_diag_from_tau_c(dataType, tmat_dev, tau_dev, max_stored_rows, nstor, tau_offset, &
                                         SM_count, debug, my_stream)
#endif
    end subroutine
