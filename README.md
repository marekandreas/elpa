...
The current release is ELPA 2025.01.001.rc1 The current supported API version
is 20241612. This release supports the earliest API version 20170403.
The current version for autotuning is also 20241612 and down to version 20170403 ist supported
...
We also provide [doxygen online documentation](https://elpa.mpcdf.mpg.de/documentation/doxygen/ELPA_DOXYGEN_PAGES/ELPA-2025.01.001.rc1/html/index.html), where you can find the definition of the interfaces.
