...
program test_invert_trm
  ...
  call timer%start("program")
   ...
   bs(:,:) = b(:,:)
    ...
    a(:,:) = CONE - CONE
    diagonalElement = (2.546_rk4, 0.0_rk4)
    do i = 1, na
   ...
   success = elpa_cholesky_complex_single(na, a, na_rows, nblk, na_cols, mpi_comm_rows, mpi_comm_cols, .true.)
   ...
   success = elpa_invert_trm_complex_single(na, a, na_rows, nblk, na_cols, mpi_comm_rows, mpi_comm_cols, .true.)
...
#ifdef WITH_MPI
   call pcgemm("N","N", na, na, na, CONE, as, 1, 1, sc_desc, a, 1, 1, &
               sc_desc, CZERO, tmp1, 1, 1, sc_desc)
#else
   call cgemm("N","N", na, na, na, CONE, as, na, a, na, CZERO, tmp1, na)
#endif

   ! tmp2 = b * tmp1
   tmp2(:,:) = 0.0_ck4
#ifdef WITH_MPI
   call pcgemm("N","N", na, na, na, CONE, b, 1, 1, sc_desc, tmp1, 1, 1, &
               sc_desc, CZERO, tmp2, 1, 1, sc_desc)
#else
   call cgemm("N","N", na, na, na, CONE, b, na, tmp1, na, CZERO, tmp2, na)
#endif
