...
module cholesky_hip
  ...
  interface
    subroutine hip_set_a_lower_to_zero_c(dataType, a_dev, na, matrixRows, my_pcol, np_cols, my_prow, np_rows, &
                                          nblk, debug, my_stream)&
                                          bind(C, name="hip_set_a_lower_to_zero_FromC")
      use, intrinsic :: iso_c_binding
      implicit none
  ...
  contains
    ...
    subroutine hip_set_a_lower_to_zero(dataType, a_dev, na, matrixRows, my_pcol, np_cols, my_prow, np_rows, &
                                        nblk, debug, my_stream)
      use, intrinsic :: iso_c_binding
      implicit none
      character(1, c_char), value     :: dataType
...
#ifdef WITH_AMD_GPU_VERSION
      call hip_set_a_lower_to_zero_c(dataType, a_dev, na, matrixRows, my_pcol, np_cols, my_prow, np_rows, &
                                      nblk, debug, my_stream)
#endif
    end subroutine
