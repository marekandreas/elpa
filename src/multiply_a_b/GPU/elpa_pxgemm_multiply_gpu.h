...
extern "C" void CONCATENATE(ELPA_GPU,  _copy_aux_full_FromC) (char dataType, intptr_t lhs_dev, intptr_t rhs_dev,
  ...
  if (dataType=='S') gpu_copy_aux_full<float> ((float  *) lhs_dev, (float  *) rhs_dev, l_rows, l_cols, lld_lhs, lld_rhs, debug, my_stream);
  if (dataType=='Z') gpu_copy_aux_full<gpuDoubleComplex>((gpuDoubleComplex *) lhs_dev, (gpuDoubleComplex *) rhs_dev, l_rows, l_cols, lld_lhs, lld_rhs, debug, my_stream);
  if (dataType=='C') gpu_copy_aux_full<gpuFloatComplex> ((gpuFloatComplex  *) lhs_dev, (gpuFloatComplex  *) rhs_dev, l_rows, l_cols, lld_lhs, lld_rhs, debug, my_stream);
}
...
extern "C" void CONCATENATE(ELPA_GPU,  _copy_and_set_zeros_aux_full_FromC) (char dataType, intptr_t mat_dev, intptr_t aux_mat_full_dev,
  ...
  if (dataType=='S') gpu_copy_and_set_zeros_aux_full<float> ((float  *) mat_dev, (float  *) aux_mat_full_dev, l_rows, l_cols, nblk_mult, debug, my_stream);
  if (dataType=='Z') gpu_copy_and_set_zeros_aux_full<gpuDoubleComplex>((gpuDoubleComplex *) mat_dev, (gpuDoubleComplex *) aux_mat_full_dev, l_rows, l_cols, nblk_mult, debug, my_stream);
  if (dataType=='C') gpu_copy_and_set_zeros_aux_full<gpuFloatComplex> ((gpuFloatComplex  *) mat_dev, (gpuFloatComplex  *) aux_mat_full_dev, l_rows, l_cols, nblk_mult, debug, my_stream);
}

//________________________________________________________________

// PETERDEBUG111:  l_cols is unused, delete it
...
template <typename T>
void gpu_copy_and_set_zeros_aux_a_full(T *mat_dev, T *aux_mat_full_dev, int l_rows, int l_cols, int nblk_mult_cols, 
                                        int nblk, int np_bc_fine, int np_cols_fine, int np_cols, int debug, gpuStream_t my_stream){
...
extern "C" void CONCATENATE(ELPA_GPU,  _copy_and_set_zeros_aux_a_full_FromC) (char dataType, intptr_t mat_dev, intptr_t aux_mat_full_dev,
                                                       int l_rows, int l_cols, int nblk_mult_cols, int nblk, int np_bc_fine, int np_cols_fine, int np_cols, int debug, gpuStream_t my_stream){
  if (dataType=='D') gpu_copy_and_set_zeros_aux_a_full<double>((double *) mat_dev, (double *) aux_mat_full_dev, l_rows, l_cols, nblk_mult_cols, nblk, np_bc_fine, np_cols_fine, np_cols, debug, my_stream);
  if (dataType=='S') gpu_copy_and_set_zeros_aux_a_full<float> ((float  *) mat_dev, (float  *) aux_mat_full_dev, l_rows, l_cols, nblk_mult_cols, nblk, np_bc_fine, np_cols_fine, np_cols, debug, my_stream);
  if (dataType=='Z') gpu_copy_and_set_zeros_aux_a_full<gpuDoubleComplex>((gpuDoubleComplex *) mat_dev, (gpuDoubleComplex *) aux_mat_full_dev, l_rows, l_cols, nblk_mult_cols, nblk, np_bc_fine, np_cols_fine, np_cols, debug, my_stream);
  if (dataType=='C') gpu_copy_and_set_zeros_aux_a_full<gpuFloatComplex> ((gpuFloatComplex  *) mat_dev, (gpuFloatComplex  *) aux_mat_full_dev, l_rows, l_cols, nblk_mult_cols, nblk, np_bc_fine, np_cols_fine, np_cols, debug, my_stream);
}
...
extern "C" void CONCATENATE(ELPA_GPU,  _copy_and_set_zeros_aux_b_full_FromC) (char dataType, intptr_t mat_dev, intptr_t aux_mat_full_dev,
  ...
  if (dataType=='S') gpu_copy_and_set_zeros_aux_b_full<float> ((float  *) mat_dev, (float  *) aux_mat_full_dev, l_rows, l_cols, nblk_mult, nblk_mult_rows, nblk, np_fine, np_rows_fine, np_rows, SM_count, debug, my_stream);
  if (dataType=='Z') gpu_copy_and_set_zeros_aux_b_full<gpuDoubleComplex>((gpuDoubleComplex *) mat_dev, (gpuDoubleComplex *) aux_mat_full_dev, l_rows, l_cols, nblk_mult, nblk_mult_rows, nblk, np_fine, np_rows_fine, np_rows, SM_count, debug, my_stream);
  if (dataType=='C') gpu_copy_and_set_zeros_aux_b_full<gpuFloatComplex> ((gpuFloatComplex  *) mat_dev, (gpuFloatComplex  *) aux_mat_full_dev, l_rows, l_cols, nblk_mult, nblk_mult_rows, nblk, np_fine, np_rows_fine, np_rows, SM_count, debug, my_stream);
}
...
extern "C" void CONCATENATE(ELPA_GPU,  _ccl_copy_buf_send_FromC) (char dataType, intptr_t a_dev, intptr_t buf_send_dev, 
  ...
  if (dataType=='S') gpu_ccl_copy_buf_send<float> ((float  *) a_dev, (float  *) buf_send_dev, l_rows, l_cols, lld_buf, nblk,
                                                    i_block_loc_fine, j_block_loc_fine, np_fine, np_bc_fine, 
                                                    np_rows_fine, np_cols_fine, np_rows, np_cols, SM_count, debug, my_stream);
  if (dataType=='Z') gpu_ccl_copy_buf_send<gpuDoubleComplex>((gpuDoubleComplex *) a_dev, (gpuDoubleComplex *) buf_send_dev, l_rows, l_cols, lld_buf, nblk,
                                                    i_block_loc_fine, j_block_loc_fine, np_fine, np_bc_fine, 
                                                    np_rows_fine, np_cols_fine, np_rows, np_cols, SM_count, debug, my_stream);
  if (dataType=='C') gpu_ccl_copy_buf_send<gpuFloatComplex> ((gpuFloatComplex  *) a_dev, (gpuFloatComplex  *) buf_send_dev, l_rows, l_cols, lld_buf, nblk,
                                                    i_block_loc_fine, j_block_loc_fine, np_fine, np_bc_fine,
                                                    np_rows_fine, np_cols_fine, np_rows, np_cols, SM_count, debug, my_stream);
}
...
extern "C" void CONCATENATE(ELPA_GPU,  _ccl_copy_buf_recv_FromC) (char dataType, intptr_t at_col_dev, intptr_t buf_recv_dev, 
  ...
  if (dataType=='D') gpu_ccl_copy_buf_recv<double>((double *) at_col_dev, (double *) buf_recv_dev, l_rows, l_cols, lld_buf, nblk,
                                                    i_block_loc_fine_max, j_block_loc_fine_max, np_fine, np_bc_fine, 
                                                    np_rows_fine, np_cols_fine, np_rows, np_cols, SM_count, debug, my_stream);
  if (dataType=='S') gpu_ccl_copy_buf_recv<float> ((float  *) at_col_dev, (float  *) buf_recv_dev, l_rows, l_cols, lld_buf, nblk,
                                                    i_block_loc_fine_max, j_block_loc_fine_max, np_fine, np_bc_fine, 
                                                    np_rows_fine, np_cols_fine, np_rows, np_cols, SM_count, debug, my_stream);
  if (dataType=='Z') gpu_ccl_copy_buf_recv<gpuDoubleComplex>((gpuDoubleComplex *) at_col_dev, (gpuDoubleComplex *) buf_recv_dev, l_rows, l_cols, lld_buf, nblk,
                                                    i_block_loc_fine_max, j_block_loc_fine_max, np_fine, np_bc_fine, 
                                                    np_rows_fine, np_cols_fine, np_rows, np_cols, SM_count, debug, my_stream);
  if (dataType=='C') gpu_ccl_copy_buf_recv<gpuFloatComplex> ((gpuFloatComplex  *) at_col_dev, (gpuFloatComplex  *) buf_recv_dev, l_rows, l_cols, lld_buf, nblk,
                                                    i_block_loc_fine_max, j_block_loc_fine_max, np_fine, np_bc_fine,
                                                    np_rows_fine, np_cols_fine, np_rows, np_cols, SM_count, debug, my_stream);
}
...
extern "C" void CONCATENATE(ELPA_GPU,  _copy_and_set_zeros_aux_ab_full_tn_nt_FromC) (char dataType, int a_transoposed, intptr_t a_dev, intptr_t b_dev, intptr_t aux_a_full_dev, intptr_t aux_b_full_dev,
  ...
  if (dataType == 'S') gpu_copy_and_set_zeros_aux_ab_full_tn_nt<float>(a_transoposed, (float *)a_dev, (float *)b_dev, (float *)aux_a_full_dev, (float *)aux_b_full_dev,
                                                      l_rows, l_cols, nblk_mult_max, nblk_mult, nblk,
                                                      np_ab_fine, np_rows, my_prow,
                                                      np_t_fine , np_cols, my_pcol,
                                                      np_dirs_fine,
                                                      SM_count, debug, my_stream);
  if (dataType == 'Z') gpu_copy_and_set_zeros_aux_ab_full_tn_nt<gpuDoubleComplex>(a_transoposed, (gpuDoubleComplex *)a_dev, (gpuDoubleComplex *)b_dev, (gpuDoubleComplex *)aux_a_full_dev, (gpuDoubleComplex *)aux_b_full_dev,
                                                                l_rows, l_cols, nblk_mult_max, nblk_mult, nblk,
                                                                np_ab_fine, np_rows, my_prow,
                                                                np_t_fine , np_cols, my_pcol,
                                                                np_dirs_fine,
                                                                SM_count, debug, my_stream);
  if (dataType == 'C') gpu_copy_and_set_zeros_aux_ab_full_tn_nt<gpuFloatComplex>(a_transoposed, (gpuFloatComplex *)a_dev, (gpuFloatComplex *)b_dev, (gpuFloatComplex *)aux_a_full_dev, (gpuFloatComplex *)aux_b_full_dev,
                                                               l_rows, l_cols, nblk_mult_max, nblk_mult, nblk,
                                                               np_ab_fine, np_rows, my_prow,
                                                               np_t_fine , np_cols, my_pcol,
                                                               np_dirs_fine,
