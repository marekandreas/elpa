...
module solve_tridi_col_gpu_new
...
!   interface ! PETERDEBUG111 cleanup
!     subroutine gpu_copy_d_to_d_tmp_c(dataType, d_dev, d_tmp_dev, na, debug, my_stream) &
! #if   defined(WITH_NVIDIA_GPU_VERSION)
!                                                   bind(C, name="cuda_copy_d_to_d_tmp_FromC")
! #elif defined(WITH_AMD_GPU_VERSION)
!                                                   bind(C, name= "hip_copy_d_to_d_tmp_FromC")
! #endif
!       use, intrinsic :: iso_c_binding
!       implicit none
!       character(1, c_char), value        :: dataType
!       integer(kind=c_intptr_t), value    :: d_dev, d_tmp_dev
!       integer(kind=c_int), value         :: na, debug
!       integer(kind=c_intptr_t), value    :: my_stream
!     end subroutine
!   end interface
...
!     subroutine gpu_copy_d_to_d_tmp(dataType, d_dev, d_tmp_dev, na, debug, my_stream)
!       use, intrinsic :: iso_c_binding
!       implicit none
!       character(1, c_char), value        :: dataType
!       integer(kind=c_intptr_t), value    :: d_dev, d_tmp_dev
...
!       integer(kind=c_intptr_t), value    :: my_stream
! #if defined(WITH_NVIDIA_GPU_VERSION) || defined(WITH_AMD_GPU_VERSION)
!       call gpu_copy_d_to_d_tmp_c(dataType, d_dev, d_tmp_dev, na, debug, my_stream)
! #endif
!     end subroutine
