...
module elpa_blas_interfaces
  ...
  interface
    ...
    implicit none
    character               :: UPLO, DIAG
    integer(kind=BLAS_KIND) :: N, LDA, INFO
    real(kind=rk8)          :: a(lda, *)
    end subroutine
  end interface
  ...
  interface
    ...
    use precision
    implicit none
    integer(kind=BLAS_KIND) :: M, N, LDA, LWORK, INFO
  ...
  interface
    ...
    implicit none
    character               :: COMPZ
    integer(kind=BLAS_KIND) :: N, LDZ, LWORK, IWORK(*), LIWORK, INFO
  ...
  interface
    ...
    implicit none
    character               :: COMPZ
    integer(kind=BLAS_KIND) :: N, LDZ, INFO
    real(kind=rk8)          :: D(*), E(*), z(ldz, *), work(*)
    end subroutine
  end interface
  ...
  interface
    ...
    use precision
    implicit none
    integer(kind=BLAS_KIND) :: DTRD1, DTRD2, N1, N2, INDEX(*)
    real(kind=rk8)          :: A(*)
    end subroutine
  end interface
  ...
  interface
    ...
    use precision
    implicit none
    integer(kind=BLAS_KIND) :: N, I, INFO
...
!#endif /* SINGLE_PRECSION_REAL */
 ...
 interface
  ...
  interface
    ...
    implicit none
    character               :: COMPZ
    integer(kind=BLAS_KIND) :: N, LDZ, LWORK, LRWORK, IWORK(*), LIWORK, INFO
