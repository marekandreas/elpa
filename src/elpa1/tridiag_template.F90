...
!       endif ! useGPU
      ...
      if (useGPU) then
        ...
        NVTX_RANGE_PUSH("kernel gpu_set_e_vec_scale_set_one_store_v_row")
        ...
        NVTX_RANGE_POP("kernel gpu_set_e_vec_scale_set_one_store_v_row")
      endif ! useGPU  
...
!$OMP END PARALLEL
   ...
   if (.not. useCCL) then
    ...
    NVTX_RANGE_POP("tridi main cycle")
