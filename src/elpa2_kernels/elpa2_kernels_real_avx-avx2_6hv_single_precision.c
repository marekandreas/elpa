...
__forceinline void hh_trafo_kernel_16_AVX_6hv_single(float* q, float* hh, int nb, int ldq, int ldh, float* scalarprods)
{
	...
	_mm256_store_ps(&q[((nb+3)*ldq)+8],q2);
	...
	_mm256_store_ps(&q[((nb+4)*ldq)+8],q2);
}
...
//	__m256 a1_2 = _mm256_load_pd(&q[(ldq*5)+4]);
//	__m256 a2_2 = _mm256_load_pd(&q[(ldq*4)+4]);
//	__m256 a3_2 = _mm256_load_pd(&q[(ldq*3)+4]);
//	__m256 a4_2 = _mm256_load_pd(&q[(ldq*2)+4]);
//	__m256 a5_2 = _mm256_load_pd(&q[(ldq)+4]);
//	__m256 a6_2 = _mm256_load_pd(&q[4]);

#ifdef __ELPA_USE_FMA__
//	register __m256 t2 = _mm256_FMA_pd(a5_2, h_6_5, a6_2);
//	t2 = _mm256_FMA_pd(a4_2, h_6_4, t2);
//	t2 = _mm256_FMA_pd(a3_2, h_6_3, t2);
//	t2 = _mm256_FMA_pd(a2_2, h_6_2, t2);
//	t2 = _mm256_FMA_pd(a1_2, h_6_1, t2);
//	register __m256 v2 = _mm256_FMA_pd(a4_2, h_5_4, a5_2);
//	v2 = _mm256_FMA_pd(a3_2, h_5_3, v2);
//	v2 = _mm256_FMA_pd(a2_2, h_5_2, v2);
//	v2 = _mm256_FMA_pd(a1_2, h_5_1, v2);
//	register __m256 w2 = _mm256_FMA_pd(a3_2, h_4_3, a4_2);
//	w2 = _mm256_FMA_pd(a2_2, h_4_2, w2);
//	w2 = _mm256_FMA_pd(a1_2, h_4_1, w2);
//	register __m256 z2 = _mm256_FMA_pd(a2_2, h_3_2, a3_2);
//	z2 = _mm256_FMA_pd(a1_2, h_3_1, z2);
//	register __m256 y2 = _mm256_FMA_pd(a1_2, h_2_1, a2_2);
#else
//	register __m256 t2 = _mm256_add_pd(a6_2, _mm256_mul_pd(a5_2, h_6_5));
...
//	register __m256 v2 = _mm256_add_pd(a5_2, _mm256_mul_pd(a4_2, h_5_4));
...
//	register __m256 w2 = _mm256_add_pd(a4_2, _mm256_mul_pd(a3_2, h_4_3));
//	w2 = _mm256_add_pd(w2, _mm256_mul_pd(a2_2, h_4_2));
//	w2 = _mm256_add_pd(w2, _mm256_mul_pd(a1_2, h_4_1));
//	register __m256 z2 = _mm256_add_pd(a3_2, _mm256_mul_pd(a2_2, h_3_2));
//	z2 = _mm256_add_pd(z2, _mm256_mul_pd(a1_2, h_3_1));
//	register __m256 y2 = _mm256_add_pd(a2_2, _mm256_mul_pd(a1_2, h_2_1));
#endif
//	register __m256 x2 = a1_2;
