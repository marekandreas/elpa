...
then
  ...
  then
    ...
    echo "module load git/2.39 autoconf automake libtool  cuda/12.1 gcc/12 openmpi_gpu/5 mkl/2025.0" >> ./run_${CLUSTER}_1node_openmpi_2GPU.sh
    echo "module load anaconda/3/2023.03 mpi4py/3.1.5" >> ./run_${CLUSTER}_1node_openmpi_2GPU.sh
